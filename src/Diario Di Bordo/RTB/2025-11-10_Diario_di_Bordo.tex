...
\begin{frame}{Risultati}
	...
	\begin{itemize}
		...
		\item Modifica della codifica sulla documentazione;
...
\begin{frame}{Attività future}
	...
	\begin{itemize}
		\item Continuazione redazione del Glossario;
		\item Preparazione del materiale per l'incontro con l'azienda.
	\end{itemize}
\end{frame}
