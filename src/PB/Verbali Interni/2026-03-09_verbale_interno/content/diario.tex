...
Il gruppo, con valutazione unanime, ha deciso di passare alla nuova durata di sprint da 2 settimane ad 1, per facilitare la stesura di preventivi, consuntivi e migliore organizzazione nei compiti assegnati.
...
\begin{itemize}
	\item Capire se l'applicazione avrà un sistema di deployment a monolite oppure a microservizi;
	\item Capire quali sono i punti ottimali in cui si utilizza il DB vettoriale;
...
I due componenti del grupppo che avevano il compito di completare il setup iniziale della repository di SmartOrder hanno mostrato i loro progressi, evidenziando i punti di forza dei risultati raggiunti.
