...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-DE\_14 \hypertarget{rf-de_14} & L'Utente deve poter visualizzare la propria descrizione nelle info del proprio profilo & \hyperref[uc_07.2]{UC\_07.2} \\
	\hline
	...
	\hline
	RF-DE\_39 \hypertarget{rf-de_39} & Il Cliente deve poter visualizzare un messaggio \vr{Non sono riuscito a rilevare il testo nell'immagine} se il modello non riesce a rilevare testo & \hyperref[uc_12]{UC\_12} \\
	\hline
	...
	\hline
	RF-DE\_56 \hypertarget{rf-de_56} & Il Cliente deve poter ricevere la notifica di la conferma di invio feedback & \hyperref[uc_56]{UC\_56} \\
	\hline
	...
	\hline
	RF-DE\_63 \hypertarget{rf-de_63} & Il Cliente deve poter ricevere una notifica di conferma dell'invio con un messaggio \vr{Ticket creato con successo} & \hyperref[uc_57]{UC\_57} \\
	\hline
	...
	\hline
	RF-DE\_75 \hypertarget{rf-de_75} & L'Admin deve poter visualizzare la conferma dell'esportazione dello storico ordini & \hyperref[uc_58]{UC\_58} \\
	\hline
	...
	\hline
	RF-DE\_78 \hypertarget{rf-de_78} & Il file JSON$^G$ esportato deve contenere il campo username [varchar(24)]: nome utente del cliente & \hyperref[uc_30]{UC\_30} \\
	\hline
	...
	\hline
	RF-DE\_86 \hypertarget{rf-de_86} & Il Cliente deve poter visualizzare una notifica di conferma della duplicazione & \hyperref[uc_60]{UC\_60} \\
	\hline
	...
	\hline
	RF-DE\_92 \hypertarget{rf-de_92} & L'Utente deve poter visualizzare il pulsante contenente il link per la pagina dell'elenco dei comandi in qualsiasi pagina & \hyperref[uc_41]{UC\_41} \\
	\hline
	...
	\hline
	RF-DE\_95 \hypertarget{rf-de_95} & Il Cliente deve poter visualizzare il comando \vr{/duplica} con la relativa spiegazione & \hyperref[uc_41.1]{UC\_41.1}\newline \hyperref[uc_42.1]{UC\_42.1} \\
	\hline
	RF-DE\_96 \hypertarget{rf-de_96} & Il Cliente deve poter visualizzare il comando \vr{/carrello} con la relativa spiegazione & \hyperref[uc_41.2]{UC\_41.2}\newline \hyperref[uc_42.2]{UC\_42.2} \\
	\hline
	RF-DE\_97 \hypertarget{rf-de_97} & Il Cliente deve poter visualizzare il comando \vr{/duplica\{xx\}} con la relativa spiegazione & \hyperref[uc_41.3]{UC\_41.3}\newline \hyperref[uc_42.3]{UC\_42.3} \\
	\hline
	RF-DE\_98 \hypertarget{rf-de_98} & Il Cliente deve poter visualizzare il comando \vr{/invia} con la relativa spiegazione & \hyperref[uc_41.4]{UC\_41.4}\newline \hyperref[uc_42.4]{UC\_42.4} \\
	\hline
	RF-DE\_99 \hypertarget{rf-de_99} & Il Cliente deve poter visualizzare il comando \vr{/annulla} con la relativa spiegazione & \hyperref[uc_41.5]{UC\_41.5}\newline \hyperref[uc_42.5]{UC\_42.5} \\
	\hline
	RF-DE\_100 \hypertarget{rf-de_100} & Il Cliente deve poter visualizzare il comando \vr{/comandi} con la relativa spiegazione & \hyperref[uc_41.6]{UC\_41.6}\newline \hyperref[uc_42.6]{UC\_42.6} \\
	\hline
	RF-DE\_101 \hypertarget{rf-de_101} & Il Cliente deve poter visualizzare i comandi inline & \hyperref[uc_43]{UC\_43} \\
	\hline
	RF-DE\_102 \hypertarget{rf-de_102} & Il Cliente deve poter visualizzare i comandi disponibili & \hyperref[uc_43.1]{UC\_43.1} \\
	\hline
	RF-DE\_103 \hypertarget{rf-de_103} & Il Cliente deve poter visualizzare il comando \vr{/duplica} & \hyperref[uc_43.1.1]{UC\_43.1.1} \\
	\hline
	RF-DE\_104 \hypertarget{rf-de_104} & Il Cliente deve poter visualizzare il comando \vr{/carrello} & \hyperref[uc_43.1.2]{UC\_43.1.2} \\
	\hline
	RF-DE\_105 \hypertarget{rf-de_105} & Il Cliente deve poter visualizzare il comando \vr{/duplica\{xx\}} & \hyperref[uc_43.1.3]{UC\_43.1.3} \\
	\hline
	RF-DE\_106 \hypertarget{rf-de_106} & Il Cliente deve poter visualizzare il comando \vr{/invia} & \hyperref[uc_43.1.4]{UC\_43.1.4} \\
	\hline
	RF-DE\_107 \hypertarget{rf-de_107} & Il Cliente deve poter visualizzare il comando \vr{/annulla} & \hyperref[uc_43.1.5]{UC\_43.1.5} \\
	\hline
	RF-DE\_108 \hypertarget{rf-de_108} & Il Cliente deve poter visualizzare il comando \vr{/comandi} & \hyperref[uc_43.1.6]{UC\_43.1.6} \\
	\hline
	RF-DE\_109 \hypertarget{rf-de_109} & Il Cliente deve poter inviare un comando nella chat & \hyperref[uc_44]{UC\_44} \\
	\hline
	RF-DE\_110 \hypertarget{rf-de_110} & Il Cliente deve poter inviare il comando \vr{/duplica} nella chat & \hyperref[uc_34]{UC\_34} \newline \hyperref[uc_44.1]{UC\_44.1} \\
	\hline
	RF-DE\_111 \hypertarget{rf-de_111} & Il Cliente deve poter inviare il comando \vr{/duplica\{xx\}} nella chat & \hyperref[uc_34]{UC\_34} \newline\hyperref[uc_44.3]{UC\_44.3} \\
	\hline
	RF-DE\_112 \hypertarget{rf-de_112} & Il Cliente deve poter inviare il comando \vr{/invia} nella chat & \hyperref[uc_26]{UC\_26} \newline \hyperref[uc_44.4]{UC\_44.4} \\
	\hline
	RF-DE\_113 \hypertarget{rf-de_113} & Il Cliente deve poter inviare il comando \vr{/annulla} nella chat & \hyperref[uc_22.1]{UC\_22.1} \newline \hyperref[uc_44.5]{UC\_44.5} \\
	\hline
	RF-DE\_114 \hypertarget{rf-de_114} & Il Cliente deve poter inviare il comando \vr{/comandi} nella chat & \hyperref[uc_44.6]{UC\_44.6} \\
	\hline
	RF-DE\_115 \hypertarget{rf-de_115} & L'Utente deve poter impostare dei filtri & \hyperref[uc_47]{UC\_47}\newline \hyperref[uc_48]{UC\_48} \\
	\hline
	RF-DE\_116 \hypertarget{rf-de_116} & L'Utente deve poter filtrare per data gli ordini presenti nello storico ordini & \hyperref[uc_47.1]{UC\_47.1}\newline \hyperref[uc_48.2]{UC\_48.2} \\
	\hline
	RF-DE\_117 \hypertarget{rf-de_117} & L'Utente deve poter visualizzare l'icona del filtro data a forma di calendario & \hyperref[uc_47.1]{UC\_47.1}\newline \hyperref[uc_48.2]{UC\_48.2} \\
	\hline
	RF-DE\_118 \hypertarget{rf-de_118} & L'Utente deve poter cliccare sull'icona del filtro data & \hyperref[uc_47.1]{UC\_47.1}\newline \hyperref[uc_48.2]{UC\_48.2} \\
	\hline
	RF-DE\_119 \hypertarget{rf-de_119} & Il filtro per data deve poter permettere di visualizzare tutti gli ordini successivi o uguali ad una data scelta & \hyperref[uc_47.1]{UC\_47.1}\newline \hyperref[uc_48.2]{UC\_48.2} \\
	\hline
	RF-DE\_120 \hypertarget{rf-de_120} & Il filtro per data deve poter permettere di visualizzare tutti gli ordini compresi tra due date scelte & \hyperref[uc_47.1]{UC\_47.1}\newline \hyperref[uc_48.2]{UC\_48.2} \\
	\hline
	RF-DE\_121 \hypertarget{rf-de_121} & L'Utente deve poter vedere il campo testuale del filtro prodotti & \hyperref[uc_47.2]{UC\_47.2}\newline \hyperref[uc_48.1]{UC\_48.1} \\
	\hline
	RF-DE\_122 \hypertarget{rf-de_122} & L'Utente deve poter scrivere nel campo testuale del filtro prodotti & \hyperref[uc_47.2]{UC\_47.2}\newline \hyperref[uc_48.1]{UC\_48.1} \\
	\hline
	RF-DE\_123 \hypertarget{rf-de_123} & L'Utente, digitando il nome del prodotto, deve poter vedere un riquadro dei prodotti presenti che contengono quella sequenza di caratteri & \hyperref[uc_47.2]{UC\_47.2}\newline \hyperref[uc_48.3]{UC\_48.3} \\
	\hline
	RF-DE\_124 \hypertarget{rf-de_124} & L'Admin deve poter vedere il campo testuale del filtro Cliente & \hyperref[uc_48.1]{UC\_48.1} \\
	\hline
	RF-DE\_125 \hypertarget{rf-de_125} & L'Admin deve poter scrivere nel campo testuale del filtro Cliente & \hyperref[uc_48.1]{UC\_48.1} \\
	\hline
	RF-DE\_126 \hypertarget{rf-de_126} & L'Admin deve poter vedere un riquadro di Clienti presenti che contengono la sequenza di caratteri inserita & \hyperref[uc_48.1]{UC\_48.1} \\
	\hline
	RF-DE\_127 \hypertarget{rf-de_127} & L'Admin deve poter scegliere dal riquadro dei Clienti presenti lo username del Cliente desiderato & \hyperref[uc_48.1]{UC\_48.1} \\
	\hline
	RF-DE\_128 \hypertarget{rf-de_128} & Il Cliente deve poter ricevere un avviso nel caso in cui invii più comandi nello stesso input & \hyperref[uc_49]{UC\_49} \\
	\hline
	RF-DE\_129 \hypertarget{rf-de_129} & Il Cliente deve poter ricevere un avviso nel caso in cui invii il comando con altro testo & \hyperref[uc_49]{UC\_49} \\
	\hline
	RF-DE\_130 \hypertarget{rf-de_130} & Il Cliente deve poter visualizzare le chat & \hyperref[uc_50]{UC\_50} \\
	\hline
	RF-DE\_131 \hypertarget{rf-de_131} & Il Cliente deve poter visualizzare una singola chat & \hyperref[uc_50.1]{UC\_50.1} \\
	\hline
	RF-DE\_132 \hypertarget{rf-de_132} & Il Cliente deve poter visualizzare la lista dei messaggi di una singola chat & \hyperref[uc_50.1.1]{UC\_50.1.1} \\
	\hline
	RF-DE\_133 \hypertarget{rf-de_133} & Il Cliente deve poter visualizzare un messaggio singolo all'interno della chat & \hyperref[uc_50.1.1.1]{UC\_50.1.1.1} \\
	\hline
	RF-DE\_134 \hypertarget{rf-de_134} & Il Cliente deve poter visualizzare un messaggio singolo dell'Utente all'interno della chat & \hyperref[uc_50.1.1.1.1]{UC\_50.1.1.1.1} \\
	\hline
	RF-DE\_135 \hypertarget{rf-de_135} & Il Cliente deve poter visualizzare un messaggio singolo dell'AI all'interno della chat & \hyperref[uc_50.1.1.1.2]{UC\_50.1.1.1.2} \\
	\hline
	RF-DE\_136 \hypertarget{rf-de_136} & Il Cliente deve poter selezionare la chat & \hyperref[uc_51]{UC\_51} \\
	\hline
	RF-DE\_137 \hypertarget{rf-de_137} & Il Cliente deve poter cancellare una chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_138 \hypertarget{rf-de_138} & Il Cliente deve poter vedere il pulsante per cancellare la chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_139 \hypertarget{rf-de_139} & Il Cliente deve poter premere il pulsante per cancellare la chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_140 \hypertarget{rf-de_140} & Il Cliente deve poter confermare la cancellazione della chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_141 \hypertarget{rf-de_141} & Il Cliente deve poter visualizzare il pulsante di invio ordine dal carrello & \hyperref[uc_53]{UC\_53} \\
	\hline
	RF-DE\_142 \hypertarget{rf-de_142} & Il Cliente deve poter premere il pulsante abilitato di invio ordine & \hyperref[uc_53]{UC\_53} \\
	\hline
	\multicolumn{3}{c}{} \\
