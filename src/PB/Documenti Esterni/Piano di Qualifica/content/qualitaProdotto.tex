...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|>{\centering\arraybackslash}p{0.13\textwidth}|
            ...
            \hline
            MQD\_02 & Requisiti desiderabili soddisfatti  &  $\geq 20\%$ & 100\% \\
            \hline
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|>{\centering\arraybackslash}p{0.13\textwidth}|
            ...
            \textbf{Metrica} & \textbf{Nome} & \textbf{Valore accettabile} & \textbf{Valore ottimo} \\
            \hline
            MQD\_07 & Code Smells per KLOC$^G$ & $\leq 15$ & $\leq 5$ \\
            \hline
            MQD\_08 & Cyclomatic Complexity$^G$ & $\leq 20$ & $\leq 10$ \\
            \hline
            MQD\_09 & Cognitive Complexity$^G$ & $\leq 15$ & $\leq 10$ \\
            \hline
        \end{tabular}
    }
    \vspace{-0.3cm}
