...
\begin{itemize}
	...
	\item \textbf{Comunicazione con la proponente}: a seguito di confronto con la proponente, è emersa la preferenza per un'architettura monolitica rispetto a una soluzione a microservizi. Tale decisione è documentata nel \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Verbali%20Esterni/2026-03-11_verbale_esterno.pdf}{Verbale esterno del 11 marzo}.
\end{itemize}