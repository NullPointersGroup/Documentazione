...
\begin{itemize}[itemsep=5pt, parsep=1pt, label=$\scriptstyle\bullet$]
	...
	\item Creazione HTML e CSS per visualizzazione Glossario$^G$
	\item Creazione script per la trascrizione del glossario$^G$ da .tex a .html
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{PianoProgetto/sprint01_preventivo}
	\caption{Sprint 1: Preventivo}
\end{figure}
...
\end{table}
Il totale consuntivato per lo sprint$^G$ è \textbf{597.5€}.\\
...
In questo sprint$^G$ ci si è molto focalizzati sul miglioramento degli script utilizzati dalle GitHub Action$^G$ e sull'implementazione della Branch$^G$ Protection.\\
Queste attività sono mirate a facilitare il lavoro futuro, compreso lo script che inserisce la G all'apice dei termini presenti nel glossario$^G$, non inizialmente definito nelle attività ma svolto nell'interesse del gruppo.\\
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.1\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|}
		...
		Amministratore$^G$ & 20(€/h) & 13 & 260 & 29 \textcolor{red}{(-13)} & 580 \textcolor{red}{(-260)} \\ \hline
		Analista$^G$       & 25(€/h) & 7.5 & 187.5 & 87.5 \textcolor{red}{(-7.5)} & 2187.5 \textcolor{red}{(-187.5)} \\ \hline
