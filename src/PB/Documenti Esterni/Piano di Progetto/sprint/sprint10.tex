...
\begin{itemize}[itemsep=5pt, parsep=1pt, label=$\scriptstyle\bullet$]
	\item Scrivere il consuntivo dello sprint 9 e il preventivo dello sprint 10
	\item Stesura Diario di Bordo del 18 marzo 2026
	\item Stesura schema del DB
	\item Stesura autenticazione e registrazione in Specifica tecnica
