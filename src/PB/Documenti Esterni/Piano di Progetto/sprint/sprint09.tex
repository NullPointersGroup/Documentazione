...
\begin{itemize}[itemsep=5pt, parsep=1pt, label=$\scriptstyle\bullet$]
	...
	\item Scrivere il consuntivo dello sprint 8 e il preventivo dello sprint 9
	\item Stesura Diario di Bordo del 11 marzo 2026
	\item Modellare il diagramma ER del DB relazionale
	\item Inserire termini Glossario
	\item Correggere i vincoli di requisito dell'Analisi dei Requisiti
\end{itemize}
