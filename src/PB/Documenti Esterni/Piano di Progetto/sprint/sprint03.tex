...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{PianoProgetto/sprint03_preventivo}
	\caption{Sprint 3: Preventivo}
\end{figure}
...
\end{table}
Il totale consuntivato per lo sprint$^G$ è \textbf{715€}.\\

Si evidenzia come il processo$^G$ di analisi sia migliorato, nonostante ciò è stato necessario l'apporto di più persone.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{PianoProgetto/sprint03_consuntivo}
	\caption{Sprint 3: Consuntivo}
\end{figure}
...
Inoltre, è necessario migliorare la stima delle ore per ogni ruolo, in particolare per gli analisti e i verificatori, al fine di ridurre le discrepanze tra preventivo e consuntivo$^G$ nei prossimi sprint.
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.1\textwidth}|p{0.15\textwidth}|p{0.17\textwidth}|}
		...
		Amministratore$^G$ & 20(€/h) & 9 & 180 & 11 \textcolor{red}{(-9)} & 220 \textcolor{red}{(-180)} \\ \hline
		Analista$^G$       & 25(€/h) & 16 & 400 & 56.5 \textcolor{red}{(-16)} & 1412.5\textcolor{red}{(-400)} \\ \hline
