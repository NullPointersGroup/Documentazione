...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{PianoProgetto/sprint04_preventivo}
	\caption{Sprint 4: Preventivo}
\end{figure}
...
La strategia per l'assegnazione e la stima delle ore per ogni ruolo si è rivelata assai efficace, come detto nel consuntivo$^G$, abbiamo accuratamente previsto le ore necessarie per questo sprint.
