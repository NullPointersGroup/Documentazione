...
Le attività previste per la PB (Product Baseline) sono riassunte nella tabella seguente:
\begin{table}[H]
	\centering
	\resizebox{\textwidth}{!}{
	\renewcommand{\arraystretch}{1.15}
	\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
		...
		\hline
		\textbf{Glossario} & Documento interno che permette di facilitare la comprensione di parole tecniche nella comunicazione fra il gruppo e la proponente. \\
		\textbf{Lettera di presentazione PB$^G$} & Simile alla Lettera di Presentazione per la RTB, esprime la volontà del gruppo di partecipare alla revisione per la PB. \\
		\hline
		\hline
	\end{tabular}}
