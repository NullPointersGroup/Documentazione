...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\textbf{Totale} & \textbf{452} & - & \textbf{11440} \\ \hline
	\end{tabular}
	\caption{Ore per ciascun ruolo e calcolo dei costi totali}
\end{table}

La revisione per la  Requirements and Technology Baseline è avvenuta il \textbf{27/02/2026}.\\

In seguito al superamento della Requirements and Technology Baseline (RTB) e all'avvio della Product Baseline (PB), il gruppo ha ridefinito la distribuzione delle ore per ottimizzare l'allocazione delle risorse in base alle nuove attività. La ripartizione aggiornata è riportata nella tabella seguente:
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\rowcolor{gray!25}
		Ruolo & Ore totali & Costo (€/h) & Costo totale (€) \\ \hline
		Responsabile$^G$ & 40 & 30 & 1200 \\ \hline
		Amministratore$^G$ & 52 & 20 & 1040 \\ \hline
		Analista$^G$ & 95 & 25 & 2375 \\ \hline
		Progettista$^G$ & 125 & 25 & 3125 \\ \hline
		Verificatore$^G$ & 115 & 15 & 1725 \\ \hline
		Programmatore$^G$ & 125 & 15 & 1875 \\ \hline
		\textbf{Totale} & \textbf{452} & - & \textbf{11340} \\ \hline
	\end{tabular}
	\caption{Ridefinizione ore per ciascun ruolo e calcolo dei costi totali}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
		...
		\hline
		\textbf{Analisi dei \newline Requisiti$^G$} & Documento esterno che ha lo scopo di definire i requisiti funzionali, requisiti non funzionali e requisiti di vincolo . Inoltre illustra tutti i casi d'uso relativi a requisiti obbligatori, non obbligatori e di sistema. \\
		\hline
...
Le nuove attività previste per la PB (Product Baseline) sono riassunte nella seguente tabella:
\begin{table}[H]
	\centering
	\resizebox{\textwidth}{!}{
	\renewcommand{\arraystretch}{1.15}
	\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
		...
		\hline
		\textbf{Minimum Viable \newline Product} &  Versione iniziale e funzionante del prodotto che implementa le funzionalità essenziali necessarie a soddisfare i requisiti fondamentali e a consentire la validazione del sistema. \\
		\hline
	\end{tabular}}
\end{table}

Nella tabella seguente sono elencati i documenti per i quali sono previste attività di correzione o aggiornamento:
\begin{table}[H]
	\centering
	\resizebox{\textwidth}{!}{
	\renewcommand{\arraystretch}{1.15}
	\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
		...
		\hline
		\textbf{Piano di Qualific} &  Documento esterno che rappresenta un documento fondamentale per la gestione e il monitoraggio continuo della qualità del progetto e dei processi coinvolti nel suo
		ciclo di vita. \\
		\hline
		\textbf{Norme di Progetto} & Documento interno che descrive il Way of Working del gruppo nel dettaglio. \\
		\hline
		\textbf{Glossario} & Documento interno che permette di facilitare la comprensione di parole tecniche nella comunicazione fra il gruppo e la proponente. \\
		\hline
	\end{tabular}}
