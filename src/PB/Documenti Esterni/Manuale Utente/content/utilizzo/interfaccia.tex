...
\begin{enumerate}[itemsep=5pt, parsep=5pt, label=\arabic*)]
	...
	\item \textbf{Menù utente}: è accessibile dalla parte superiore e ti permette di accedere rapidamente al tuo profilo, allo storico degli ordini e ad altre funzionalit\`a dell'account.
