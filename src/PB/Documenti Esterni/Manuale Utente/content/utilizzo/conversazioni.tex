\subsubsection{Gestione conversazioni}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ManualeUtente/conversazioni}
	\caption{Area conversazioni}
\end{figure}
Ogni conversazione è indipendente e contiene il suo storico di messaggi, cos\`i puoi lavorare su pi\`u richieste senza confonderti.

\subsubsubsection{Creazione nuova conversazione}
...
\subsubsubsection{Selezione conversazione}
...
\subsubsubsection{Gestione conversazione}

Ogni conversazione pu\`o essere gestita tramite il menù accessibile con l'icona a tre puntini, accanto al suo nome.
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{ManualeUtente/conversazioni_menu}
	\caption{Menù gestione conversazione}
\end{figure}
