...
\term{camelCase}
Convenzione di denominazione utilizzata nella programmazione in cui la prima parola è scritta in minuscolo e ogni parola successiva inizia con la lettera maiuscola, senza spazi o separatori.\\
...
\term{Cognitive Complexity}
Metrica che valuta la difficoltà di comprensione del codice considerando la struttura, i livelli di annidamento e i flussi di controllo.
...
\term{Cost Performance Index}
Metrica che misura l'efficienza dei costi di un progetto, calcolata come rapporto tra il valore del lavoro completato e il costo effettivamente sostenuto.

\term{Cruscotto}
Interfaccia che mostra in modo sintetico dati e indicatori utili per monitorare lo stato e le prestazioni di un sistema o processo.
