...
\term{Schedule Performance Index}
Metrica che misura l'efficienza temporale di un progetto, calcolata come rapporto tra il valore del lavoro effettivamente completato e il valore del lavoro che si sarebbe dovuto completare secondo la pianificazione.
...
\term{snake\_case}
Convenzione di denominazione in cui le parole sono scritte in minuscolo e separate dal carattere underscore \_.\\

\term{Specifica Tecnica}
La Specifica Tecnica descrive e motiva le scelte architetturali per la realizzazione delle componenti del prodotto, elenca inoltre le tecnologie utilizzate per realizzarle.

\term{Speech-to-text}
Tecnologia che consente di convertire automaticamente il linguaggio parlato in testo scritto.
...
\term{SQL}
Acronimo di \textit{Structured Query Language}, è un linguaggio di programmazione con lo scopo di creare, filtrare ed eliminare dati memorizzati all'interno di tabelle nei database relazionali.
