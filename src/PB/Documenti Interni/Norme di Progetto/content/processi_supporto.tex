...
\subsubsection{Strumenti a supporto}
Per supportare le attività di Verifica$^G$ descritte, il gruppo utilizza GitHub$^G$, imponendo che ogni modifica$^G$ alla documentazione o al codice venga prima sottoposta a revisione attraverso una Pull Request.\\ 
