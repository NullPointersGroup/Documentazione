\section{Processi Primari}
	...
	L'attività di fornitura definisce le modalità con cui il gruppo si impegna a realizzare e consegnare il prodotto \textbf{SmartOrder} al proponente$^G$ Ergon Informatica Srl, nel rispetto di tempi, costi, qualità e requisiti concordati. \\
	Questa fase, che comprende tutte le attività di pianificazione$^G$, negoziazione, esecuzione, controllo e consegna, inizia con un'analisi preliminare dei requisiti per definire le funzionalità$^G$ del sistema, sulla base della quale è possibile negoziare i dettagli con la proponente$^G$, presentare una pianificazione$^G$ di progetto$^G$ e stimare una data di consegna plausibile.
    ...
    \begin{itemize}[itemsep=3pt, parsep=1pt, label=$\scriptstyle\bullet$]
		\item La \href{https://nullpointersgroup.github.io/Documentazione/output/Candidatura/Lettera_di_Presentazione.pdf}{Lettera di Presentazione} per la candidatura al progetto$^G$;
		\item La \href{https://nullpointersgroup.github.io/Documentazione/output/RTB/Lettera_di_Presentazione_RTB.pdf}{Lettera di Presentazione per la Requirements and Technology Baseline$^G$} (RTB$^G$);
		\item La \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Lettera_di_Presentazione_PB.pdf}{Lettera di Presentazione per la Product Baseline$^G$} (RTB$^G$);
	\end{itemize}
	Ciascuna lettera ha lo scopo di presentare formalmente il gruppo NullPointers Group, illustrando l’impegno nel rispettare gli obiettivi e i vincoli delle rispettive Baseline.\\[0.5em]
	\medskip
	...
	\textbf{Obiettivo del documento}:\\
	Il \href{https://nullpointersgroup.github.io/Documentazione/output/Candidatura/Preventivo_Costi.pdf}{Preventivo Costi} serve a mostrare come NullPointers Group ha pianificato il progetto$^G$, stimando ore e costi per ciascun ruolo e definendo le responsabilità dei membri del team.\\[0.5em]
	\medskip
	...
	\textbf{Obiettivo del documento}:\\
	La \href{https://nullpointersgroup.github.io/Documentazione/output/Candidatura/Valutazione_Capitolati.pdf}{Valutazione dei Capitolati} è un documento che analizza ogni capitolato$^G$ proposto, individuando punti di forza e criticità.\\
	...
	Riporta tutti i contenuti discussi durante l’incontro, incluse richieste, chiarimenti, decisioni, vincoli, feedback$^G$ e indicazioni fornite dai referenti esterni. Il suo scopo è garantire trasparenza, tracciabilità e un allineamento costante tra il team e la proponente$^G$, riducendo il rischio di fraintendimenti o interpretazioni errate.\\[0.5em]
	\medskip
	\textbf{Redattore$^G$}: Responsabile\\
	\medskip
	\textbf{Utilizzo}: Esterno\\
	...
	Il documento permette di mantenere una traccia chiara e condivisa dell’avanzamento del lavoro.\\[0.5em]
	\medskip
	\textbf{Redattore$^G$}: Responsabile\\
	\medskip
	...
	\textbf{Obiettivo del documento}:\\
	Il \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti%20Interni/Glossario.pdf}{Glossario$^G$} 
	definisce in modo univoco i termini tecnici, gli acronimi e i concetti chiave del progetto. È considerato dal team uno strumento fondamentale perché standardizza la terminologia e facilita la comunicazione tra tutti i soggetti coinvolti.\\
	...
	Le \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti%20Interni/Norme_di_Progetto.pdf}{Norme di Progetto$^G$}, ovvero il presente documento, definiscono il Way of Working$^G$ adottato da NullPointers Group per lo sviluppo$^G$ del progetto$^G$ SmartOrder.\\
	Le norme di progetto$^G$ mirano a stabilire regole, metodologie e standard per garantire coerenza, qualità e uniformità nella produzione$^G$ di documenti, codice e altri artefatti di progetto. Disciplinano la gestione e il versionamento$^G$ dei file, la comunicazione interna ed esterna, il tracciamento dei requisiti e delle decisioni, nonché le procedure di revisione e approvazione.\\
	...
	Il \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti%20Esterni/Piano_di_Progetto.pdf}{Piano di Progetto$^G$} 
	...
	È uno strumento operativo fondamentale per coordinare il team, gestire le risorse, tracciare le decisioni e verificare la conformità agli standard definiti nelle Norme di Progetto$^G$, garantendo il rispetto di obiettivi, requisiti e vincoli.\\[0.5em]
	\medskip
	\textbf{Redattore$^G$}: Responsabile\\
	\medskip
	\textbf{Utilizzo}: Esterno\\
	...
	Il \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti%20Esterni/Piano_di_Qualifica.pdf}{Piano di Qualifica$^G$} 
	definisce strategie, criteri e procedure per verificare e validare SmartOrder, garantendo il rispetto dei requisiti funzionali, non funzionali e di vincolo.\\
	Include la pianificazione$^G$ delle attività di test$^G$, i casi di verifica$^G$, i criteri di accettazione e il tracciamento delle anomalie. È quindi un riferimento operativo per assicurare la qualità del prodotto, monitorare i test$^G$ e supportare le decisioni sul rilascio.\\[0.5em]
	\medskip
	...
	La Specifica Tecnica$^G$ descrive e motiva le scelte architetturali per la realizzazione delle componenti del prodotto, elenca inoltre le tecnologie utilizzate per realizzarle.\\[0.5em]
	\medskip
	\textbf{Redattore$^G$}: Progettista\\
	\medskip
	\textbf{Utilizzo}: Esterno\\
	\medskip 
	\begin{tabular}{@{}l l}
	...
	Il Manuale Utente$^G$ fornisce le indicazioni riguardanti l'utilizzo del prodotto, esponendo le varie funzionalità$^G$ e il loro significato all'interno del prodotto.
	Il documento elenca i passaggi per utilizzare correttamente il software, fornendo informazioni chiare sui requisiti di sistema, sulla procedura di installazione e sulla 
	risoluzione di eventuali problemi.\\[0.5em] 
	\medskip
	\textbf{Redattore$^G$}: Programmatore\\
	\medskip
	\textbf{Utilizzo}: Esterno\\
	\medskip 
	\begin{tabular}{@{}l l}
	...
	\begin{itemize}[itemsep=3pt, parsep=1pt, label=$\scriptstyle\bullet$]
	    ...
	    \item \textbf{WhatsApp$^G$}: per la comunicazione asincrona tra il team e la proponente.
	\end{itemize}
	
	\subsection{Sviluppo}
	L'attività di sviluppo$^G$ è un insieme strutturato di attività che guidano la realizzazione del software, dalla definizione dei requisiti fino al rilascio del prodotto finale.\\ 
	...
	L'obiettivo è creare un prodotto di qualità, conforme ai requisiti e realizzato gestendo i rischi in modo efficace, mantenendo la qualità e la tracciabilità delle attività, e assicurando che ogni rilascio sia coerente con gli obiettivi concordati con il committente.
	...
	\end{enumerate}
	Queste attività sono cicliche e aggiornate ad ogni sprint$^G$, permettendo un progresso costante e la tracciabilità di tutte le decisioni.

	\subsubsection{Analisi dei Requisiti}
	L'Analisi dei Requisiti$^G$ è una fase che ha lo scopo di identificare tutte le esigenze funzionali e i requisiti che il sistema software dovrà soddisfare.\\
	Il risultato di questa attività viene formalizzato nell’apposito documento di \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti%20Esterni/Analisi_dei_Requisiti.pdf}{Analisi dei Requisiti$^G$} il quale verrà utilizzato come punto di partenza per le fasi successive: progettazione$^G$, codifica e test.\\
	Espone nel dettaglio i casi d’uso e i requisiti che compongono gli elementi fondamentali per lo sviluppo$^G$ del progetto.
		...
		Questa convenzione ha lo scopo di garantire l’univocità e la tracciabilità di ciascun Caso d’Uso.\\ 
		Ad ogni identificatore inoltre è associato un nome ed una breve descrizione che riassume in maniera concisa lo scopo del caso d’uso.
		...
		\end{itemize}
		Per maggiore chiarezza sui casi d’uso e i requisiti si consiglia la lettura del documento di \href{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti%20Esterni/Analisi_dei_Requisiti.pdf}{Analisi dei Requisiti$^G$}.
	
	\subsubsection{Codifica}
	Il compito del Programmatore$^G$ è tradurre in codice eseguibile quanto definito durante l'analisi e la progettazione. Per garantire coerenza, manutenibilità e qualità del prodotto software, è imperativo che ogni sviluppatore aderisca alle seguenti regole e convenzioni.

	\subsubsubsection{Convenzioni sintattiche}
	La verifica$^G$ della conformità alle convenzioni di codifica viene effettuata tramite strumenti automatici e revisione manuale durante le Pull Request.\\
    ...
    \item \textbf{Python$^G$ (backend$^G$)}: tutti gli identificatori (variabili, funzioni, metodi, classi) devono utilizzare esclusivamente lo \texttt{snake\_case$^G$}.
    \item \textbf{React$^G$ (frontend$^G$)}:
    \begin{itemize}
        \item \texttt{PascalCase$^G$} per i nomi dei componenti React$^G$;
        \item \texttt{camelCase$^G$} per variabili, funzioni, metodi e hook.
    \end{itemize}
    \item \textbf{Lingua dei commenti}: i commenti devono essere scritti in italiano, per favorire la comprensione immediata da parte di tutti i membri del team durante le revisioni.
...
\end{itemize}
	...
	\subsubsection{Strumenti a supporto}
	\phantomsection\label{sec:strumenti-supporto}
	Per supportare il processo$^G$ di sviluppo$^G$ vengono usati i seguenti strumenti: \vspace{-0.5em}
	\begin{itemize}[itemsep=3pt, parsep=1pt, label=$\scriptstyle\bullet$]
		\item \textbf{StarUML}: Per creare diagrammi UML$^G$, come ad esempio i diagrammi delle classi in fase di progettazione. 
	\end{itemize}
