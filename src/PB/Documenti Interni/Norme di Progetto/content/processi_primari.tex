\section{Processi Primari}
	...
	La Specifica Tecnica descrive e motiva le scelte architetturali per la realizzazione delle componenti del prodotto, elenca inoltre le tecnologie utilizzate per realizzarle.\\[0.5em]
	\medskip
	...
	Il Manuale Utente fornisce le indicazioni riguardanti l'utilizzo del prodotto, esponendo le varie funzionalità$^G$ e il loro significato all'interno del prodotto.
	...
	\begin{itemize}[itemsep=3pt, parsep=1pt, label=\textbullet]
		...
		\item Per il \textbf{codice di produzione$^G$}: usare \texttt{camelCase} per variabili, \texttt{PascalCase} per i nomi delle classi e \texttt{snake\_case} per metodi e funzioni.
