\section{Processi Primari}
	...
	\begin{itemize}[itemsep=3pt, parsep=1pt, label=\textbullet]
		...
		\item Per il \textbf{codice di produzione$^G$}: usare \texttt{camelCase$^G$} per variabili, \texttt{PascalCase$^G$} per i nomi delle classi e \texttt{snake\_case$^G$} per metodi e funzioni.
