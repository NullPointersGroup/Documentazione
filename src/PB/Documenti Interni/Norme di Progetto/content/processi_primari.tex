\section{Processi Primari}
    ...
    \item \textbf{Python (backend)}: tutti gli identificatori (variabili, funzioni, metodi, classi) devono utilizzare esclusivamente lo \texttt{snake\_case$^G$}.
    \item \textbf{React (frontend)}:
    \begin{itemize}
        \item \texttt{PascalCase$^G$} per i nomi dei componenti React;
