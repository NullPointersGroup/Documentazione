\section{Processi Primari}
	...
	\end{itemize}
	Ciascuna lettera ha lo scopo di presentare formalmente il gruppo NullPointers Group, illustrando l’impegno nel rispettare gli obiettivi e i vincoli delle rispettive Baseline$^G$.\\[0.5em]
	\medskip
	...
	Le norme di progetto mirano a stabilire regole, metodologie e standard per garantire coerenza, qualità e uniformità nella produzione di documenti, codice e altri artefatti di progetto. Disciplinano la gestione e il versionamento dei file, la comunicazione interna ed esterna, il tracciamento dei requisiti e delle decisioni, nonché le procedure di revisione e approvazione.\\
	...
	È uno strumento operativo fondamentale per coordinare il team, gestire le risorse, tracciare le decisioni e verificare la conformità agli standard definiti nelle Norme di Progetto, garantendo il rispetto di obiettivi, requisiti e vincoli.\\[0.5em]
	\medskip
	\textbf{Redattore$^G$}: Responsabile\\
	\medskip
	\textbf{Utilizzo}: Esterno\\
	...
	Include la pianificazione delle attività di test, i casi di verifica, i criteri di accettazione e il tracciamento delle anomalie. È quindi un riferimento operativo per assicurare la qualità del prodotto, monitorare i test e supportare le decisioni sul rilascio.\\[0.5em]
	\medskip
	\textbf{Redattore$^G$}: Amministratore\\
	\medskip
	\textbf{Utilizzo}: Esterno\\
	...
	Il Manuale Utente fornisce le indicazioni riguardanti l'utilizzo del prodotto, esponendo le varie funzionalità e il loro significato all'interno del prodotto.
	...
	\subsubsection{Strumenti a supporto}
	\phantomsection\label{sec:strumenti-supporto}
	Per supportare il processo di sviluppo vengono usati i seguenti strumenti: \vspace{-0.5em}
	\begin{itemize}[itemsep=3pt, parsep=1pt, label=$\scriptstyle\bullet$]
		\item \textbf{StarUML}: Per creare diagrammi UML, come ad esempio i diagrammi delle classi in fase di progettazione. 
	\end{itemize}
