...
\vspace*{0.05\textheight}
    ...
    Nel corso della fase di sviluppo, \textbf{NullPointers Group} ha realizzato un \textit{MVP}, reso disponibile al seguente link:
    
    \begin{center}
        \url{https://github.com/NullPointersGroup/SmartOrder}
    \end{center}
    
    L'approvazione del suddetto MVP è provata dal verbale esterno del 13/04/2026, reso disponibile al seguente link:
    
    \begin{center}
    	\url{https://nullpointersgroup.github.io/Documentazione/output/PB/Verbali%20Esterni/2026-04-13_verbale_esterno.pdf}
    \end{center}

    Tutta la documentazione prodotta per la PB è consultabile e sempre aggiornata nella relativa sezione del nostro sito: 
    \begin{center}
