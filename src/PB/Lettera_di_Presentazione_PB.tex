...
\vspace*{0.05\textheight}
    ...
    {
        \centering
        \Huge\bfseries Presentazione PB\par
        \vspace{0.5cm}
    }
    ...
    con il presente documento il team \textbf{NullPointers Group} desidera comunicarVi formalmente la propria intenzione di sottoporsi alla revisione della Product Baseline.\\
	La revisione riguarderà il progetto$^G$ sviluppato per il capitolato$^G$ C8 (SmartOrder: Analisi multimodale per la creazione automatica di ordini) proposto da Ergon Informatica Srl:
    
    \begin{center}
        \url{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C8.pdf}
    \end{center}

    Nel corso della fase di sviluppo$^G$, \textbf{NullPointers Group} ha realizzato un \textit{MVP$^G$}, reso disponibile al seguente link:
    
    \begin{center}
        \url{https://github.com/NullPointersGroup/SmartOrder}
    \end{center}
    
    L'approvazione del suddetto MVP$^G$ è provata dal verbale esterno del 13/04/2026, reso disponibile al seguente link:
    
    \begin{center}
    	\url{https://nullpointersgroup.github.io/Documentazione/output/PB/Verbali%20Esterni/2026-04-13_verbale_esterno.pdf}
    \end{center}

    Tutta la documentazione prodotta per la PB$^G$ è consultabile e sempre aggiornata nella relativa sezione del nostro sito: 
    \begin{center}
    ...
    \begin{itemize}
        ...
        \item Specifica Tecnica$^G$ v1.0.0
        \item Manuale Utente$^G$ v1.0.0
        \item Piano di Qualifica$^G$ v2.0.0
        \item Piano di Progetto$^G$ v2.0.0
        \item Analisi dei Requisiti$^G$ v2.0.0
        \item Norme di Progetto$^G$ v2.0.0
        \item Glossario$^G$ v2.0.0
    \end{itemize}

    Con la presente lettera desideriamo aggiornarVi in merito ai costi e alle tempistiche del progetto. \\
	La spesa totale effettivamente sostenuta è di 11.342,50 €, inferiore al budget inizialmente previsto di 11.440,00 €, con un risparmio complessivo di 97,50 €.\\[0.3cm]
