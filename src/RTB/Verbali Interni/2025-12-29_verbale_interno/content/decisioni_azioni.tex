...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|p{0.12\textwidth}|p{0.65\textwidth}|}
			...
			Codice & Descrizione \\
			\hline
			VI$^G$ 15.1 & Creazione repository$^G$ dedicata in vista del PoC.\\
			\hline
			...
			\hline
			VI$^G$ 15.6 & Utilizzare sempre caption per l'immagine raffigurante lo schema UML$^G$ del caso d'uso.\\
			\hline
...
Qualsiasi modifica$^G$ alle issue$^G$ relativa all'Analisi dei Requisiti$^G$, dovute a ricontrolli durante la stesura, saranno tracciate nel sistema di progetto.
