...
In questo sprint, fino al 12/01/2026, i ruoli saranno i seguenti: \\
\begin{center}
	Marco Brunello $\rightarrow$ Responsabile \\
	Tommaso Ceron $\rightarrow$ Analista \\
	Matteo Mazzareto $\rightarrow$ Analista \\
	Laura Pieripolli $\rightarrow$ Analista\\
	Lisa Casagrande $\rightarrow$ Analista, Verificatore \\
	Luca Marcuzzo $\rightarrow$ Analista, Verificatore \\
\end{center}
