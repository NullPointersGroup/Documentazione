...
Ogni issue$^G$ sarà inoltre associata a una milestone, corrispondente allo sprint$^G$ di riferimento, così da garantire una pianificazione$^G$ ordinata e una visione temporale delle consegne. Parallelamente, nei project board verranno inserite le attività raggruppate rispetto alle due principali scadenze previste, identificate come RTB$^G$ e PB.\\
In questo modo il project board fungerà da quadro di sintesi delle attività critiche e delle tappe fondamentali del progetto, mentre la gestione delle issue$^G$ consentirà il monitoraggio delle singole produzioni documentali.
