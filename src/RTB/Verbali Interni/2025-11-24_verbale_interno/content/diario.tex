...
Ogni issue$^G$ sarà inoltre associata a una milestone, corrispondente allo sprint$^G$ di riferimento, così da garantire una pianificazione$^G$ ordinata e una visione temporale delle consegne.
Parallelamente, nei project board verranno inserite le attività raggruppate rispetto alle due principali scadenze previste, identificate come RTB$^G$ e PB.\\
