...
\end{center}
È comunque prevista una sessione di analisi dei requisiti$^G$ del gruppo, da effettuare prima del 10/12 per l'incontro con la proponente.
...
Ogni documento avrà la issue$^G$ finale di approvazione da parte del responsabile.

\subsection{Definizione nomenclatura branch$^G$ e nomenclatura issue}
...
\begin{center}
	\begin{tabular}{|c|c|}
		...
		\hline
		Norme di Progetto$^G$ & feature/norme-progetto \\
		\hline
		Piano di Progetto$^G$ & feature/piano-progetto \\
		\hline
