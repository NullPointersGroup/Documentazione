...
In compenso però il gruppo si è accordato sulla convenzione della nomenclatura dei test per il tracciamento:
\begin{itemize}
	...
	\item TA\_XX: \textbf{T}est di \textbf{A}ccetazione numero xx
\end{itemize}
Inoltre ogni associato ad ogni singolo test ci sarà il suo stato:
\begin{itemize}
	\item S: Superato
	\item I: Implementato
