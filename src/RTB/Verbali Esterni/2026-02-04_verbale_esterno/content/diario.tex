...
L'azienda ha inoltre suggerito di rendere visibile la query generata dall'agente per avere un maggior controllo sul processo e migiorarne l'ottimizzazione, consentendo inoltre di controllare se l'agente genera una singola query o query multiple.
