...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|p{0.1\textwidth}|p{0.65\textwidth}|}
			...
			Codice & Descrizione \\
			\hline
			VE 1.1 & I meeting verranno svolti all’occorrenza, con preavviso. Gli incontri online avverranno tramite Google Meet. \\ 
			\hline
			...
			\hline
			VE 1.12 & È necessaria la validazione dell'ordine: l'utente deve confermare l'ordine completo prima dell'invio. \\
			\hline
			VE 1.13 & Per prodotti ambigui il sistema consulta lo storico del cliente, in mancanza di esso propone opzioni invece di ``indovinare''. \\
			\hline
		\end{tabular}
	}
\end{table}