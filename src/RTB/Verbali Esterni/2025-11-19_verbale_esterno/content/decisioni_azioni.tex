...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|p{0.13\textwidth}|p{0.65\textwidth}|}
			...
			\hline
			VE$^G$ 1.3 & Abbiamo deciso di proseguire con Git$^G$ Flow e di mantenere il nostro metodo di suddivisione del lavoro in feature branch$^G$, che verranno eliminati dopo il merge. \\ 
			\hline
			...
			\hline
			VE$^G$ 1.14 & Per prodotti ambigui il sistema consulta lo storico del cliente, in mancanza di esso propone opzioni invece di \vr{indovinare}. \\
			\hline
		\end{tabular}
	}
\end{table}