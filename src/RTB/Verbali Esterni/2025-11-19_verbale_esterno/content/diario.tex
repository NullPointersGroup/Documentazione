...
\subsection{Gestione del codice e Versioning}
    ...
    \begin{enumerate}[resume*, itemsep=0pt, parsep=1pt, leftmargin=*, label=\arabic*.]
        \item Come si devono gestire i \textbf{conflitti di merge} in un team di più persone e quale sia la procedura corretta quando, mentre si lavora su una funzionalità$^G$, qualcun altro modifica$^G$ la stessa parte di codice.
    \end{enumerate} \vspace{-0.5em}
...
\subsection{Tecnologie, Formazione e Infrastruttura}
    ...
    \begin{itemize}[itemsep=0pt, parsep=1pt, label=--]
        ...
        \item \textbf{Back-end} (Logica e AI): \textbf{Python}, ambiente ideale per lo sviluppo$^G$ di modelli di intelligenza artificiale$^G$ e machine learning$^G$;
    ...
    \begin{enumerate}[resume*, itemsep=0pt, parsep=1pt, leftmargin=*, label=\arabic*.]
        \item Organizzazione di \textbf{sessioni di formazione} sulle tecnologie non conosciute, come Docker$^G$ o React$^G$.
    \end{enumerate} \vspace{-0.5em}
