...
\begin{itemize}
	...
	\item Si può considerare il sistema di machine learning come un qualcosa definito e modificato da noi, e quindi non considerabile né attore$^G$ principale né attore$^G$ secondario?
\end{itemize}