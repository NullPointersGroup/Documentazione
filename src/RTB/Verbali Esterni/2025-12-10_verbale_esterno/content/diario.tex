...
\begin{enumerate}
	\item Utilizzo di un middleware$^G$ per separare ulteriormente la comunicazione tra i componenti oppure attraverso connettori standard come una fonte dati ODBC$^G$.
\end{enumerate}