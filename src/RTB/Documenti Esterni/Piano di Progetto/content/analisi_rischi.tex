...
\begin{table}[h]
	...
	\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
		...
		\hline
		Mitigazione & All'inizio di ogni sprint$^G$ si tiene conto di quanto si è impegnati con lo studio di altri corsi, riducendo il consuntivo$^G$ orario per renderlo più realistico. \\
		\hline
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			\hline
			\textbf{Mitigazione} & All'inizio di ogni sprint$^G$ si tiene conto di quanto si è impegnati con altre attività, riducendo il consuntivo$^G$ orario per renderlo più realistico. \\
			\hline
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			\hline
			\textbf{Mitigazione} & All'inizio di ogni Sprint$^G$ si considera il livello di conoscenza delle tecnologie coinvolte, riducendo di conseguenza le ore produttive previste, poiché gran parte del tempo sarà dedicata ad acquisire le competenze necessarie per svolgere le task$^G$ dello Sprint. \\
			\hline
			\textbf{Frequenza probabile di avvenimento} & Elevata \\
			\hline
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			\hline
			\textbf{Descrizione} & Ogni individuo incaricato può svolgere male il proprio compito a causa di un'incomprensione della task$^G$ o di una sua definizione poco chiara.\\
			\hline
