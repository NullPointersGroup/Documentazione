...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			Descrizione & Il gruppo non ha esperienza in progetti di queste dimensioni con front-end e back-end complessi e tecnologie eterogenee. Sono inclusi possibili errori e lunghe sessioni di debugging. \\ \hline
			Mitigazione & All'inizio di ogni sprint si valuta il livello di conoscenza delle tecnologie, riducendo le ore produttive previste per includere il tempo di apprendimento. \\ \hline
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			Descrizione & Le task possono richiedere più tempo del previsto, causando ritardi negli sprint e sovraccarico dei membri del gruppo. \\ \hline
			Mitigazione & Pianificare task realistiche e suddividere task grandi in sotto-task. \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
		...
		Mitigazione & All'inizio di ogni sprint si tiene conto dell'impegno richiesto da altri corsi, riducendo il consuntivo orario per renderlo più realistico. \\ \hline
		Frequenza \newline probabile di \newline avvenimento & Media \\ \hline
		Ripercussioni & Elevate \\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
		...
		Mitigazione & All'inizio di ogni sprint si tiene conto degli impegni extra, riducendo il consuntivo orario per renderlo coerente alla disponibilità reale. \\ \hline
		Frequenza \newline probabile di \newline avvenimento & Elevata \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
		...
		Descrizione & Un membro può svolgere male una task per incomprensioni o una definizione poco chiara del compito. \\ \hline
		Mitigazione & Il gruppo deve concordare task sempre chiare e ogni membro deve verificare di aver compreso correttamente cosa deve fare. \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
		...
		Mitigazione & Effettuare incontri chiarificatori con il proponente, validare i requisiti dopo ogni sprint e produrre documentazione condivisa. \\ \hline
		Frequenza \newline probabile di \newline avvenimento & Media \\ \hline
		Ripercussioni & Elevate \\ \hline
	\end{tabular}}
