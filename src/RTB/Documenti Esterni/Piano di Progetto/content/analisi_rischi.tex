...
\begin{table}[h]
	...
	\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
		...
		\hline
		Frequenza \newline probabile di \newline avvenimento & Medio \\
		\hline
		Ripercussioni & Elevata \\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			\hline
			\textbf{Frequenza probabile di avvenimento} & Elevato \\
			\hline
			\textbf{Ripercussioni} & Medio, grazie alla nostra intensità dichiarata \\
			\hline
	\end{tabular}}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			\hline
			\textbf{Ripercussioni} & Molto elevato \\
			\hline
	\end{tabular}}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			\hline
			\textbf{Mitigazione} & All'inizio di ogni sprint si tiene conto di quanto poco si conosce una determinata tecnologia, per limitare le ore produttive dedicate siccome la maggior parte saranno per imparare le conoscenze adeguate allo svolgimento delle task$^G$ di quello Sprint.\\
			\hline
			\textbf{Frequenza probabile di avvenimento} & Elevato \\
			\hline
			\textbf{Ripercussioni} & Elevato \\
			\hline
	\end{tabular}}
