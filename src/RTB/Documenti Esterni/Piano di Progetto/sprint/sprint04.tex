...
\begin{itemize}[itemsep=5pt, parsep=1pt, label=$\scriptstyle\bullet$]
	\item Continuazione Analisi di Requisiti: sezione Introduzione, Attori, Requisiti di qualità e di vincolo
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|}
		...
		T. Ceron      & - & - & 8 & - & 1 & - \\ \hline
		L. Pieripolli & - & - & 8 & - & 1 & - \\ \hline
		L. Marcuzzo   & 4 & 5 & - & - & - & - \\ \hline
		M. Brunello   & - & - & 8 & - & 1 & - \\ \hline
		L. Casagrande & - & 5 & 8 & - & - & - \\ \hline
	\end{tabular}
	\caption{Sprint 4: Preventivo}
\end{table}

Il totale preventivato per lo sprint$^G$ è \textbf{1165€}.\\
