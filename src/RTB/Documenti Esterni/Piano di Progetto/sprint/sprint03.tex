...
Il totale preventivato per lo sprint è \textbf{965€}.\\
...
\end{table}
Il totale consuntivato per lo sprint è \textbf{715€}.\\

Si evidenzia come il processo di analisi sia migliorato, nonostante ciò è stato necessario l'apporto di più persone.
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.1\textwidth}|p{0.15\textwidth}|p{0.17\textwidth}|}
		...
		Responsabile   & 30(€/h) & 3 & 90 & 41 \textcolor{red}{(-3)} & 1230 \textcolor{red}{(-90)} \\ \hline
		Amministratore & 20(€/h) & 9 & 180 & 11 \textcolor{red}{(-9)} & 220 \textcolor{red}{(-180)} \\ \hline
		Analista       & 25(€/h) & 16 & 400 & 56.5 \textcolor{red}{(-16)} & 1412.5\textcolor{red}{(-400)} \\ \hline
		Progettista    & 25(€/h) & - & - & 125 & 3125 \\ \hline
		Verificatore   & 15(€/h) & 3 & 45 & 104 \textcolor{red}{(-3)} & 1560 \textcolor{red}{(-45)} \\ \hline
		Programmatore  & 15(€/h) & - & - & 125 & 1875 \\ \hline
		Totale         & - & 31 & 715 & 462.5 \textcolor{red}{(-31)} & 9422.5 \textcolor{red}{(-715)} \\ \hline
	\end{tabular}
	\caption{Sprint 3: Aggiornamento risorse}
\end{table}

\subsubsubsection{Rischi incontrati}
In questo sprint non si sono verificati rischi.
...
Inoltre, è necessario migliorare la stima delle ore per ogni ruolo, in particolare per gli analisti e i verificatori, al fine di ridurre le discrepanze tra preventivo e consuntivo nei prossimi sprint.

\subsubsubsection{Retrospettiva}
Tutte le attività pianificate sono state completate; tuttavia, una di esse è stata portata avanti esclusivamente tramite un documento condiviso non pubblico e, per questo motivo, il relativo risultato non è ancora stato pubblicato nel repository.