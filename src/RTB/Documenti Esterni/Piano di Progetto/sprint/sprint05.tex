...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|}
		...
		T. Ceron      & - & - & 3,5 \textcolor{red}{(-0.5)} & - & - & - \\ \hline
		L. Pieripolli & - & - & 3,5 \textcolor{green}{(+0.5)} & - & - & - \\ \hline
		L. Marcuzzo   & - & - & 3 \textcolor{red}{(-2)} & - & 2 & - \\ \hline
		M. Brunello   & 3 & - & - & - & - & - \\ \hline
		L. Casagrande & - & - & 4 \textcolor{green}{(+2)} & - & 4 \textcolor{green}{(+1)} & - \\ \hline
	\end{tabular}
	\caption{Sprint 5: Consuntivo}
\end{table}
In questo sprint la distribuzione delle ore non e' stata accuratamente rispettata, a causa di una leggera sottostima dell'impegno richiesto per ultimare la Analisi dei Requisiti.
E' inoltre stata pianificata una riunione con la azienda Proponente in seguito all'inserimento delle ore a preventivo di questo sprint e questo ha causato un'ora in piu' di verifica del Verbale Esterno.
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.1\textwidth}|p{0.13\textwidth}|p{0.12\textwidth}|}
		...
		Responsabile$^G$   & 30(€/h) & 3 & 90 & 37 \textcolor{red}{(-4)} & 1110 \textcolor{red}{(-120)} \\ \hline
		Amministratore$^G$ & 20(€/h) & - & - & 11 & 220 \\ \hline
		Analista$^G$       & 25(€/h) & 19 & 475 & 26.5 \textcolor{red}{(-30)} & 662.5 \newline \textcolor{red}{(-750)} \\ \hline
		Progettista$^G$    & 25(€/h) & - & - & 125 & 3125 \\ \hline
		Verificatore$^G$   & 15(€/h) & 6 & 90 & 101 \textcolor{red}{(-3)} & 1515 \textcolor{red}{(-45)} \\ \hline
