...
\end{table}
In questo sprint$^G$ la distribuzione$^G$ delle ore non è stata accuratamente rispettata, a causa di una leggera sottostima dell'impegno richiesto per ultimare l'Analisi dei Requisiti$^G$.
\begin{figure}[H]
	\centering
