...
\begin{itemize}[itemsep=5pt, parsep=1pt, label=$\scriptstyle\bullet$]
    \item Definizione Test$^G$ nelle Norme di Progetto$^G$.
    \item Scrittura Test$^G$ di Sistema nel Piano di Qualifica$^G$.
    \item Scrittura Test$^G$ di Regressione nel Piano di Qualifica$^G$.
...
\begin{itemize}
	\item Scrittura dei test$^G$ di Accettazione nel Piano di Qualifica$^G$.
\end{itemize}
