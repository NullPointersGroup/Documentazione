...
Non è stato incontrato alcun rischio.
...
Nella prossima fase, il gruppo dovrà affrontare la definizione chiara e concisa su cosa inserire nel documento \vrs{Analisi dei Requisiti}.\\
Per questo motivo, è stato deciso di inserire nel preventivo molte più ore alla figura dell'\vrs{Analista} poiché ci sarà bisogno di molto tempo da dedicare.\\
Inoltre, dato che ormai tutti noi abbiamo studiato al meglio la scrittura dei documenti, sono state dedicate meno ore alla figura dell'\vrs{Amministratore} poiché si prevede che la scrittura sarà più veloce e fluida e meno tempo dedicato per lo studio dei documenti.
