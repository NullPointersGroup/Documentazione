...
Il totale preventivato per lo sprint è \textbf{795€}.\\
...
\begin{table}[H]
	...
	\makebox[\textwidth][c]{
		\begin{minipage}{1.2\textwidth}
			...
			% Seconda tabella con i dati e i bordi
			\begin{tabular}{|p{0.2\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.13\textwidth}|p{0.12\textwidth}|}
				\hline
...
\end{table}
Il totale consuntivato per lo sprint è \textbf{705€}.\\

Si evidenzia come il processo di verifica sia migliorato, nonostante ciò è stato necessario l'apporto di più persone. Per questo il gruppo ha l'obiettivo di migliorare i processi di verifica.
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.2\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.1\textwidth}|p{0.15\textwidth}|p{0.17\textwidth}|}
		...
		Responsabile   & 30(€/h) & 3 & 90 & 44 \textcolor{red}{(-3)} & 1320 \textcolor{red}{(-90)} \\ \hline
		Amministratore & 20(€/h) & 9 & 180 & 20 \textcolor{red}{(-9)} & 400 \textcolor{red}{(-180)} \\ \hline
		Analista       & 25(€/h) & 15 & 375 & 72.5 \textcolor{red}{(-15)} & 1812.5 \textcolor{red}{(-375)} \\ \hline
		Progettista    & 25(€/h) & - & - & 125 & 3125 \\ \hline
		Verificatore   & 15(€/h) & 4 & 60 & 107 \textcolor{red}{(-4)} & 1605 \textcolor{red}{(-60)} \\ \hline
...
Anche in questo sprint è stato incontrato il rischio RE2, che sottolinea la difficoltà del gruppo di trovare una quadra per la stesura corretta di un buon preventivo, seppur consapevoli che sia praticamente impossibile avere il 100\% di accuratezza in ogni Sprint.

\subsubsubsection{Efficacia delle strategie di gestione di mitigazione dei rischi}
La strategia di migliorare gli script e le GitHub Action si è rivelata efficace, non ci sono stati problemi nella verifica dei documenti e ogni componente ha svolto il suo ruolo al meglio delle sue possibilità.\\
...
Questa strategia sarà utile anche per il futuro, perché sarà una base di partenza per la scrittura del PoC e in generale del codice.

\subsubsubsection{Migliorie da attuare per le attività future}
Nella prossima fase, il gruppo dovrà definire in modo chiaro e conciso cosa inserire nel documento \vrs{Analisi dei Requisiti}.\\
Per questo motivo, è stato deciso di inserire nel preventivo molte più ore alla figura dell'\vrs{Analista}.\\
Inoltre, dato che ormai tutti noi abbiamo studiato al meglio la scrittura dei documenti, sono state dedicate meno ore alla figura dell'\vrs{Amministratore} poiché si prevede che la scrittura della documentazione sarà più veloce e fluida.
