...
Sono stati incontrati i rischi RP1 ed RE1, già definiti nei rischi attesi. \\
...
Per il rischio RP1, si è deciso di tenere questa strategia di abbassamento di carico di lavoro per i componenti abbassando la difficoltà da svolgere delle attività per tutti i membri del gruppo per impedire il non completamento a fine Sprint, inserendo attività troppo grosse e impossibili da svolgere con componenti in meno.\\
Per il rischio RE1, essendo la prima volta che ci cimentavamo in questa complessità, si è deciso di approfondire la tecnologia richiesta per facilitare l'implementazione nella repository del codice sorgente del prodotto.
