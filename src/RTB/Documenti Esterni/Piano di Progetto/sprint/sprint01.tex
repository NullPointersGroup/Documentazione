...
\end{tabular}
\newline \newline
Questo primo periodo ha una durata di 11 giorni invece di 2 settimane in modo da permettere al gruppo di allinearsi al lunedì come data di chiusura dello sprint.\\
...
\begin{itemize}[itemsep=5pt, parsep=1pt, label=$\scriptstyle\bullet$]
	...
	\item RE1: per l'implementazione della Branch Protection
...
Il totale preventivato per lo sprint è \textbf{790€}.\\
	...
	\makebox[\textwidth][c]{%
		\begin{minipage}{1.2\textwidth}
			...
			\begin{tabular}{p{0.2\textwidth}p{0.12\textwidth}p{0.12\textwidth}p{0.12\textwidth}p{0.12\textwidth}p{0.12\textwidth}p{0.12\textwidth}}
				...
				\rotatebox{45}{\textbf{Programmatore}} & \rotatebox{45}{\textbf{Verificatore}} & \rotatebox{45}{\textbf{Progettista}} \\
			\end{tabular}
...
\end{table}
Il totale consuntivato per lo sprint è \textbf{597.5€}.\\
...
L'implementazione della Branch Protection ha portato ad un aumento di ore a M. Brunello maggiore dei suoi compagni a causa della sottostima del rischio tecnologico.
...
\begin{table}[H]
	\centering
	\begin{tabular}{|p{0.2\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.1\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|}
		\hline
		\rowcolor{gray!25}
		Ruolo & Costo & Ore & Costo \newline effettivo & Ore \newline rimanenti & Budget \newline rimanente \\ \hline
		Responsabile   & 30(€/h) & 3 & 90 & 47 \textcolor{red}{(-3)} & 1410 \textcolor{red}{(-90)} \\ \hline
		Amministratore & 20(€/h) & 13 & 260 & 29 \textcolor{red}{(-13)} & 580 \textcolor{red}{(-260)} \\ \hline
		Analista       & 25(€/h) & 7.5 & 187.5 & 87.5 \textcolor{red}{(-7.5)} & 2187.5 \textcolor{red}{(-187.5)} \\ \hline
		Progettista    & 25(€/h) & - & - & 125 & 3125 \\ \hline
		Verificatore   & 15(€/h) & 4 & 60 & 111 \textcolor{red}{(-4)} & 1665 \textcolor{red}{(-60)} \\ \hline
		Programmatore  & 15(€/h) & - & - & 125 & 1875 \\ \hline
		Totale         & - & 27.5 & 597.5 & 524.5 \newline \textcolor{red}{(-27.5)} & 10842.5 \newline \textcolor{red}{(-597.5)} \\ \hline
	\end{tabular}
...
Il secondo rischio invece è stato incontrato in quanto l'implementazione della Branch Protection è stata molto più complessa del previsto.

\subsubsubsection{Efficacia delle strategie di gestione di mitigazione dei rischi}
Per il rischio RP1, è stata adottata la strategia di ridurre il carico di lavoro, diminuendo il livello di difficoltà delle attività assegnate a tutti i membri del gruppo. Questo per evitare di non completare lo Sprint a causa dell'assegnazione di attività troppo ampie o impossibili da portare a termine con un numero ridotto di componenti.\\
Per il rischio RE1, trattandosi della nostra prima esperienza con un livello di complessità simile, abbiamo deciso di utilizzare un metodo simile anche nella repository del codice sorgente del prodotto, in modo da trarre doppio vantaggio da quest'implementazione.\\
Per il rischio RE2, come gruppo cerchiamo di migliorare Sprint per Sprint nella scrittura del preventivo per renderlo più accurato, poiché le ore produttive sono state decisamente minori rispetto a quelle aspettate.

\subsubsubsection{Migliorie da attuare per le attività future}
In questo sprint ci si è molto focalizzati sul miglioramento degli script utilizzati dalle GitHub Action e sull'implementazione della Branch Protection.\\
...
Nei prossimi sprint c'è l'obiettivo di iniziare a scrivere i documenti rimanenti e di migliorare quelli già presenti.

\subsubsubsection{Retrospettiva}
Al termine dello Sprint, è stata confermata la chiusura di tutte le attività inserite nelle attività da svolgere con l'aggiunta dello script menzionato precedentemente.