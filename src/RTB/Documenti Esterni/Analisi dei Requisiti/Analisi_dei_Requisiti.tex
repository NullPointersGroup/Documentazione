...
\makeatletter
\newcommand{\l@subsubsubsection}{\@dottedtocline{4}{6.0em}{3.7em}}
\makeatother
...
% --- Registrazione livello 5 per tocloft ---
\makeatletter
\newcommand{\l@subsubsubsubsection}{\@dottedtocline{5}{8.5em}{4em}}
\makeatother

\setcounter{secnumdepth}{5}
\setcounter{tocdepth}{5}

% --- Creazione livello 6 (subssubsubsubsubsection) 
\let\subsubsubsubsubsection\relax
...
{\normalfont\normalsize\bfseries}
{\thesubsubsubsubsubsection}{0.5em}{}

\titlespacing*{\subsubsubsubsubsection}{0pt}{1ex}{1ex}

\makeatletter
\newcommand{\l@subsubsubsubsubsection}{\@dottedtocline{6}{13em}{4.5em}}
\makeatother
...
\input{content/funzionali}
\newpage

\input{content/qualita}
\newpage

\input{content/vincolo}
\newpage

\input{content/riepilogo}
