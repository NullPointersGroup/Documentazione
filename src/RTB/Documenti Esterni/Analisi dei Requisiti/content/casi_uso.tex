...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|p{0.25\textwidth}|p{0.65\textwidth}|}
			...
			\hline
			Generalizzazioni & Relazione che descrive una specializzazione di un caso d'uso rispetto a uno più generale. In UML indica esclusività: i casi d'uso specializzati rappresentano varianti del caso d'uso generale e non vincolano il percorso di esecuzione \\
			\hline
