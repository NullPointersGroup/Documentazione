...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OB\_76 \hypertarget{rf-ob_76} & Il Cliente deve poter visualizzare i singoli elementi del riepilogo ordine dalla chat & \hyperref[uc_26.2.1]{UC\_26.2.1} \newline \hyperref[uc_34.1.1]{UC\_34.1.1} \\
	\hline
	RF-OB\_77 \hypertarget{rf-ob_77} & Il Cliente deve poter confermare l'invio dell'ordine con un input & \hyperref[uc_26.3]{UC\_26.3}\newline \hyperref[uc_34.2]{UC\_34.2} \\
	\hline
	RF-OB\_78 \hypertarget{rf-ob_78} & Il Cliente deve poter visualizzare la conferma dell'invio dell'ordine & \hyperref[uc_54]{UC\_54}\\
	\hline
	RF-OB\_79 \hypertarget{rf-ob_79} & Il Cliente deve poter annullare l'invio dell'ordine con un input & \hyperref[uc_26.4]{UC\_26.4}\\
	\hline
	RF-OB\_80 \hypertarget{rf-ob_80} & Se il carrello è vuoto dopo il comando \vr{/invia} il Cliente visualizza un messaggio di errore che avvisa che il carrello è vuoto & \hyperref[uc_27]{UC\_27} \\
	\hline
	RF-OB\_81 \hypertarget{rf-ob_81} & Il Cliente deve poter visualizzare un messaggio riguardante l'ambiguità dei prodotti & \hyperref[uc_21]{UC\_21} \\
	\hline
	RF-OB\_82 \hypertarget{rf-ob_82} & Il Cliente deve poter riformulare l'ordine per prodotti ambigui & \hyperref[uc_21.1]{UC\_21.1} \\
	\hline
	RF-OB\_83 \hypertarget{rf-ob_83} & Il Cliente deve poter annullare la disambiguazione & \hyperref[uc_22]{UC\_22} \\
	\hline
	RF-OB\_84 \hypertarget{rf-ob_84} & Il Cliente deve poter rispondere \vr{/annulla} per uscire dalla disambiguazione & \hyperref[uc_22.1]{UC\_22.1} \\
	\hline
	RF-OB\_85 \hypertarget{rf-ob_85} & Il Cliente deve poter ricevere conferma dell'annullamento della disambiguazione & \hyperref[uc_55]{UC\_55} \\
	\hline
	RF-OB\_86 \hypertarget{rf-ob_86} & Il Cliente deve poter vedere il pulsante \vr{Nuova chat} & \hyperref[uc_28]{UC\_28} \\
	\hline
	RF-OB\_87 \hypertarget{rf-ob_87} & L'Utente deve poter cliccare sul pulsante \vr{Nuova chat} & \hyperref[uc_28]{UC\_28} \\
	\hline
	RF-OB\_88 \hypertarget{rf-ob_88} & Il Cliente deve poter visualizzare una notifica di errore nel caso in cui il prodotto non venga duplicato correttamente & \hyperref[uc_35]{UC\_35} \\
	\hline
	RF-OB\_89 \hypertarget{rf-ob_89} & L'Utente deve poter visualizzare il pulsante \vr{visualizza storico ordini} & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_90 \hypertarget{rf-ob_90} & L'Utente deve poter schiacciare il pulsante \vr{visualizza storico ordini} & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_91 \hypertarget{rf-ob_91} & L'Admin deve poter visualizzare una pagina separata contenente lo storico totale degli ordini di tutti i Clienti & \hyperref[uc_36]{UC\_36} \\
	\hline
	RF-OB\_92 \hypertarget{rf-ob_92} & Il Cliente deve poter visualizzare una pagina separata contente lo storico totale dei suoi ordini & \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_93 \hypertarget{rf-ob_93} & La lista completa degli ordini deve essere visualizzata in pagine contenenti al massimo 10 ordini ciascuna & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_94 \hypertarget{rf-ob_94} & Il caricamento di una pagina non implica il caricamento delle pagine successive & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_95 \hypertarget{rf-ob_95} & L'Utente deve poter visualizzare il singolo ordine nello storico & \hyperref[uc_36.1]{UC\_36.1} \newline \hyperref[uc_45.1]{UC\_45.1} \\
	\hline
	RF-OB\_96 \hypertarget{rf-ob_96} & L'Utente deve poter visualizzare il codice ordine & \hyperref[uc_36.1.1]{UC\_36.1.1} \newline \hyperref[uc_45.1.1]{UC\_45.1.1} \\
	\hline
	RF-OB\_97 \hypertarget{rf-ob_97} & L'Utente deve poter visualizzare la data dell'ordine & \hyperref[uc_36.1.2]{UC\_36.1.2} \newline \hyperref[uc_45.1.2]{UC\_45.1.2} \\
	\hline
	RF-OB\_98 \hypertarget{rf-ob_98} & L'Admin deve poter visualizzare lo username del Cliente & \hyperref[uc_36.1.3]{UC\_36.1.3} \\
	\hline
	RF-OB\_99 \hypertarget{rf-ob_99} & L'Utente deve poter visualizzare il dettaglio di un ordine specifico & \hyperref[uc_37]{UC\_37} \newline \hyperref[uc_46]{UC\_46} \\
	\hline
	RF-OB\_100 \hypertarget{rf-ob_100} & L'Admin deve poter visualizzare lo username del Cliente & \hyperref[uc_37.1]{UC\_37.1} \\
	\hline
	RF-OB\_101 \hypertarget{rf-ob_101} & L'Utente deve poter visualizzare i prodotti dell'ordine & \hyperref[uc_37.2]{UC\_37.2} \newline \hyperref[uc_46.1]{UC\_46.1} \\
	\hline
	RF-OB\_102 \hypertarget{rf-ob_102} & L'Utente deve poter visualizzare il nome dei prodotti & \hyperref[uc_37.2.1]{UC\_37.2.1} \newline \hyperref[uc_46.1.1]{UC\_46.1.1} \\
	\hline
	RF-OB\_103 \hypertarget{rf-ob_103} & L'Utente deve poter visualizzare la descrizione dei prodotti & \hyperref[uc_37.2.2]{UC\_37.2.2} \newline \hyperref[uc_46.1.2]{UC\_46.1.2} \\
	\hline
	RF-OB\_104 \hypertarget{rf-ob_104} & L'Utente deve poter visualizzare la quantità dei prodotti & \hyperref[uc_37.2.3]{UC\_37.2.3} \newline \hyperref[uc_46.1.3]{UC\_46.1.3} \\
	\hline
	RF-OB\_105 \hypertarget{rf-ob_105} & L'Utente deve poter visualizzare la data dell'ordine & \hyperref[uc_37.3]{UC\_37.3} \newline \hyperref[uc_46.2]{UC\_46.2} \\
	\hline
	RF-OB\_106 \hypertarget{rf-ob_106} & L'Utente deve poter visualizzare il numero dell'ordine & \hyperref[uc_37.4]{UC\_37.4} \newline \hyperref[uc_46.3]{UC\_46.3} \\
	\hline
	RF-OB\_107 \hypertarget{rf-ob_107} & Il Cliente deve poter visualizzare il pulsante per duplicare l'ordine & \hyperref[uc_38]{UC\_38} \\
	\hline
	RF-OB\_108 \hypertarget{rf-ob_108} & Il Cliente deve poter cliccare sul pulsante per duplicare l'ordine & \hyperref[uc_38]{UC\_38} \\
	\hline
	RF-OB\_109 \hypertarget{rf-ob_109} & Il Cliente deve poter confermare la duplicazione dell'ordine & \hyperref[uc_38.1]{UC\_38.1} \\
	\hline
	RF-OB\_110 \hypertarget{rf-ob_110} & Il Cliente deve poter visualizzare la notifica di errore duplicazione ordine & \hyperref[uc_39]{UC\_39} \\
	\hline
	\multicolumn{3}{c}{} \\
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-DE\_103 \hypertarget{rf-de_103} & Il Cliente deve poter visualizzare i comandi disponibili & \hyperref[uc_43.1]{UC\_43.1} \\
	\hline
	RF-DE\_104 \hypertarget{rf-de_104} & Il Cliente deve poter visualizzare il comando \vr{/duplica} & \hyperref[uc_43.1.1]{UC\_43.1.1} \\
	\hline
	RF-DE\_105 \hypertarget{rf-de_105} & Il Cliente deve poter visualizzare il comando \vr{/carrello} & \hyperref[uc_43.1.2]{UC\_43.1.2} \\
	\hline
	RF-DE\_106 \hypertarget{rf-de_106} & Il Cliente deve poter visualizzare il comando \vr{/duplica\{xx\}} & \hyperref[uc_43.1.3]{UC\_43.1.3} \\
	\hline
	RF-DE\_107 \hypertarget{rf-de_107} & Il Cliente deve poter visualizzare il comando \vr{/invia} & \hyperref[uc_43.1.4]{UC\_43.1.4} \\
	\hline
	RF-DE\_108 \hypertarget{rf-de_108} & Il Cliente deve poter visualizzare il comando \vr{/annulla} & \hyperref[uc_43.1.5]{UC\_43.1.5} \\
	\hline
	RF-DE\_109 \hypertarget{rf-de_109} & Il Cliente deve poter visualizzare il comando \vr{/comandi} & \hyperref[uc_43.1.6]{UC\_43.1.6} \\
	\hline
	...
	\hline
	RF-DE\_135 \hypertarget{rf-de_135} & Il Cliente deve poter visualizzare una singola chat & \hyperref[uc_50.1]{UC\_50.1} \\
	\hline
	RF-DE\_136 \hypertarget{rf-de_136} & Il Cliente deve poter visualizzare la lista dei messaggi di una singola chat & \hyperref[uc_50.1.1]{UC\_50.1.1} \\
	\hline
	RF-DE\_137 \hypertarget{rf-de_137} & Il Cliente deve poter visualizzare un messaggio singolo all'interno della chat & \hyperref[uc_50.1.1.1]{UC\_50.1.1.1} \\
	\hline
	RF-DE\_138 \hypertarget{rf-de_137} & Il Cliente deve poter visualizzare un messaggio singolo dell'Utente all'interno della chat & \hyperref[uc_50.1.1.1.1]{UC\_50.1.1.1.1} \\
	\hline
	RF-DE\_139 \hypertarget{rf-de_137} & Il Cliente deve poter visualizzare un messaggio singolo dell'AI all'interno della chat & \hyperref[uc_50.1.1.1.2]{UC\_50.1.1.1.2} \\
	\hline
	RF-DE\_140 \hypertarget{rf-de_138} & Il Cliente deve poter selezionare la chat & \hyperref[uc_51]{UC\_51} \\
	\hline
	RF-DE\_141 \hypertarget{rf-de_139} & Il Cliente deve poter cancellare una chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_142 \hypertarget{rf-de_140} & Il Cliente deve poter vedere il pulsante per cancellare la chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_143 \hypertarget{rf-de_141} & Il Cliente deve poter premere il pulsante per cancellare la chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_144 \hypertarget{rf-de_142} & Il Cliente deve poter confermare la cancellazione della chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_145 \hypertarget{rf-de_143} & Il Cliente deve poter visualizzare il pulsante di invio ordine dal carrello & \hyperref[uc_53]{UC\_53} \\
	\hline
	RF-DE\_146 \hypertarget{rf-de_144} & Il Cliente deve poter premere il pulsante abilitato di invio ordine & \hyperref[uc_53]{UC\_53} \\
	\hline
	\multicolumn{3}{c}{} \\
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OP\_16 \hypertarget{rf-op_16} & Deve essere visualizzata una notifica a schermo che informa della corretta creazione dell'Utente & \hyperref[uc_59]{UC\_59} \\
	\hline
