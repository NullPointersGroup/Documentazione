...
\begin{longtable}{|>{\raggedright}p{0.15\textwidth}|>{\raggedright\arraybackslash}p{0.6\textwidth}|>{\raggedright\arraybackslash}p{0.25\textwidth}|}
	...
	\hline
	RF-OB\_57 & Il Cliente deve visualizzare il messaggio riepilogativo con i dettagli dell'ordine quando invia \verb|/invia| nella chat & UC\_26.2 \\
	\hline
	...
	\hline
	RF-OB\_61 & Il Cliente deve visualizzare la conferma dell'invio dell'ordine & UC\_26.4\\
	\hline
	RF-OB\_61 & Il Cliente deve poter annullare l'invio dell'ordine con un input & UC\_26.5\\
	\hline
	RF-OB\_61 & Il Cliente visualizza una conferma di non invio dell'ordine & UC\_26.5\\ %si può anche togliere secondo me
	\hline
	RF-OB\_63 & Il Cliente a seguito della conferma visualizza un riepilogo dell'ordine & UC\_26\newline UC\_26.2\newline UC\_34 \\ %i sottocasi di 26.2 sono nel 19.qualcosa! (più su)
	\hline
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.6\textwidth}|>{\raggedright\arraybackslash}p{0.25\textwidth}|}
	...
	\hline
	RF-DE\_77 & L'Admin deve poter ottenere il file di log in formato JSON & UC\_29 \\
	\hline
	...
	\hline
	RF-DE\_125 & L'Admin visualizza i filtri per data & UC\_47.2, \newline UC\_25.1, \newline UC\_25.2\\
	\hline
	RF-DE\_125 & L'Admin può impostare i filtri per data & UC\_47.2, \newline UC\_25.1, \newline UC\_25.2\\
	\hline
	\multicolumn{3}{c}{} \\
