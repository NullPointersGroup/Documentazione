...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OB\_79 \hypertarget{rf-ob_79} & Il Cliente deve poter annullare l'invio dell'ordine con un input & \hyperref[uc_26.5]{UC\_26.5}\\
	\hline
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-DE\_136 \hypertarget{rf-de_136} & Il Cliente deve poter visualizzare la lista adei messaggi di una singola chat & \hyperref[uc_50.1.1]{UC\_50.1.1} \\
	\hline
	...
	\hline
	RF-DE\_138 \hypertarget{rf-de_138} & Il Cliente deve poter selezionare la chat & \hyperref[uc_51]{UC\_51} \\
	\hline
	RF-DE\_139 \hypertarget{rf-de_139} & Il Cliente deve poter cancellare una chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_140 \hypertarget{rf-de_140} & Il Cliente deve poter vedere il pulsante per cancellare la chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_141 \hypertarget{rf-de_141} & Il Cliente deve poter premere il pulsante per cancellare la chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_142 \hypertarget{rf-de_142} & Il Cliente deve poter confermare la cancellazione della chat & \hyperref[uc_52]{UC\_52} \\
	\hline
	RF-DE\_143 \hypertarget{rf-de_143} & Il Cliente deve poter visualizzare il pulsante di invio ordine dal carrello & \hyperref[uc_53]{UC\_53} \\
	\hline
	RF-DE\_144 \hypertarget{rf-de_144} & Il Cliente deve poter premere il pulsante abilitato di invio ordine & \hyperref[uc_53]{UC\_53} \\
	\hline
	\multicolumn{3}{c}{} \\
