...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OP\_08 \hypertarget{rf-op_8} & L'Admin deve poter selezionare il ruolo Admin & \hyperref[uc_32.1]{UC\_32.1} \\
	\hline
	RF-OP\_09 \hypertarget{rf-op_09} & L'Admin deve poter visualizzare il campo di input per inserire lo username & \hyperref[uc_32.2]{UC\_32.2} \\
	\hline
	RF-OP\_10 \hypertarget{rf-op_10} & L'Admin deve poter inserire lo username & \hyperref[uc_32.2]{UC\_32.2} \\
	\hline
	RF-OP\_11 \hypertarget{rf-op_11} & Lo username deve essere univoco & \hyperref[uc_32.2.2]{UC\_32.2.2} \\
	\hline
	RF-OP\_12 \hypertarget{rf-op_12} & L'Admin deve poter visualizzare una notifica di errore se lo username è già presente nel sistema & \hyperref[uc_32.2.2]{UC\_32.2.2} \\
	\hline
	RF-OP\_13 \hypertarget{rf-op_13} & L'Admin deve poter visualizzare il campo di input per l'inserimento dell'email & \hyperref[uc_32.3]{UC\_32.3} \\
	\hline
	RF-OP\_14 \hypertarget{rf-op_14} & L'Admin deve poter inserire l'email & \hyperref[uc_32.3]{UC\_32.3} \\
	\hline
	RF-OP\_15 \hypertarget{rf-op_15} & L'Admin deve poter visualizzare l'errore nel caso in cui l'email non fosse nel formato corretto & \hyperref[uc_32.3.1]{UC\_32.3.1} \\
	\hline
	RF-OP\_16 \hypertarget{rf-op_16} & L'Admin deve poter visualizzare l'errore nel caso in cui l'email sia già presente nel sistema & \hyperref[uc_32.3.2]{UC\_32.3.2} \\
	RF-OP\_17 \hypertarget{rf-op_17} & Deve essere visualizzata una notifica a schermo che informa della corretta creazione dell'Utente & \hyperref[uc_32.4]{UC\_32.4} \\
	\hline
	RF-OP\_18 \hypertarget{rf-op_18} & L'Admin deve poter visualizzare la notifica di errore creazione utente & \hyperref[uc_33]{UC\_33}\\
	\hline
	\multicolumn{3}{c}{} \\
