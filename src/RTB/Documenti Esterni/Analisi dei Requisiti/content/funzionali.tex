...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OB\_85 \hypertarget{rf-ob_85} & Il Cliente deve poter vedere il pulsante \vr{Nuova chat} & \hyperref[uc_28]{UC\_28} \\
	\hline
	RF-OB\_86 \hypertarget{rf-ob_86} & L'Utente deve poter cliccare sul pulsante \vr{Nuova chat} & \hyperref[uc_28]{UC\_28} \\
	\hline
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-DE\_140 \hypertarget{rf-de_140} & Il Cliente deve poter vedere l'icona del carrello & \hyperref[uc_53]{UC\_53} \\
	\hline
	RF-DE\_141 \hypertarget{rf-de_141} & Il Cliente deve poter premere l'icona del carrello & \hyperref[uc_53]{UC\_53} \\
	\hline
	RF-DE\_142 \hypertarget{rf-de_141} & Il Cliente deve poter vedere il riepilogo del carrello & \hyperref[uc_53.1]{UC\_53.1} \\
	\hline
	RF-DE\_143 \hypertarget{rf-de_142} & Il Cliente deve poter visualizzare il pulsante abilitato di invio ordine dal carrello & \hyperref[uc_54]{UC\_54} \\
	\hline
	RF-DE\_144 \hypertarget{rf-de_143} & Il Cliente deve poter premere il pulsante di invio ordine & \hyperref[uc_54]{UC\_54} \\
	\hline
	RF-DE\_145 \hypertarget{rf-de_145} & Il Cliente deve poter premere il pulsante di invio ordine & \hyperref[uc_54]{UC\_54} \\
	\hline
	RF-DE\_146 \hypertarget{rf-de_146} & Il Cliente deve poter visualizzare il pulsante disabilitato di invio ordine & \hyperref[uc_55]{UC\_55} \\
	\hline
	\multicolumn{3}{c}{} \\
