...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OB\_33 \hypertarget{rf-ob_33} & Il Cliente deve poter visualizzare un messaggio di errore al superamento di 4096 caratteri & \hyperref[uc_10]{UC\_10} \\
	\hline
	...
	\hline
	RF-OB\_65 \hypertarget{rf-ob_65} & Il Cliente deve poter inviare il comando testuale \vr{/carrello} & \hyperref[uc_19.1]{UC\_19.1} \\
	\hline
	...
	\hline
	RF-OB\_76 \hypertarget{rf-ob_76} & Il Cliente deve poter confermare l'invio dell'ordine con un input & \hyperref[uc_26.3]{UC\_26.3}\newline \hyperref[uc_34.1]{UC\_34.1} \\
	\hline
	RF-OB\_77 \hypertarget{rf-ob_77} & Il Cliente deve poter visualizzare la conferma dell'invio dell'ordine & \hyperref[uc_26.4]{UC\_26.4}\\
	\hline
	RF-OB\_78 \hypertarget{rf-ob_78} & Il Cliente deve poter annullare l'invio dell'ordine con un input & \hyperref[uc_26.5]{UC\_26.5}\\
	\hline
	RF-OB\_79 \hypertarget{rf-ob_79} & Se il carrello è vuoto dopo il comando \vr{/invia} il Cliente visualizza un messaggio di errore che avvisa che il carrello è vuoto & \hyperref[uc_27]{UC\_27} \\
	\hline
	RF-OB\_80 \hypertarget{rf-ob_80} & Il Cliente deve poter visualizzare un messaggio riguardante l'ambiguità dei prodotti & \hyperref[uc_21]{UC\_21} \\
	\hline
	RF-OB\_81 \hypertarget{rf-ob_81} & Il Cliente deve poter riformulare l'ordine per prodotti ambigui & \hyperref[uc_21.1]{UC\_21.1} \\
	\hline
	RF-OB\_82 \hypertarget{rf-ob_82} & Il Cliente deve poter annullare la disambiguazione & \hyperref[uc_22]{UC\_22} \\
	\hline
	RF-OB\_83 \hypertarget{rf-ob_83} & Il Cliente deve poter rispondere \vr{/annulla} per uscire dalla disambiguazione & \hyperref[uc_22.1]{UC\_22.1} \\
	\hline
	RF-OB\_84 \hypertarget{rf-ob_84} & Il Cliente deve poter ricevere conferma dell'annullamento della disambiguazione & \hyperref[uc_22.2]{UC\_22.2} \\
	\hline
	RF-OB\_85 \hypertarget{rf-ob_85} & Il Cliente deve poter vedere il pulsante \vr{Nuova chat} per iniziare una nuova sessione & \hyperref[uc_28]{UC\_28} \\
	\hline
	RF-OB\_86 \hypertarget{rf-ob_86} & L'Utente deve poter cliccare sul pulsante \vr{Nuova chat} per iniziare una nuova sessione & \hyperref[uc_28]{UC\_28} \\
	\hline
	RF-OB\_87 \hypertarget{rf-ob_87} & Il Cliente deve poter visualizzare una notifica di errore nel caso in cui il prodotto non venga duplicato correttamente & \hyperref[uc_35]{UC\_35} \\
	\hline
	RF-OB\_88 \hypertarget{rf-ob_88} & L'Utente deve poter visualizzare il pulsante \vr{visualizza storico ordini} & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_89 \hypertarget{rf-ob_89} & L'Utente deve poter schiacciare il pulsante \vr{visualizza storico ordini} & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_90 \hypertarget{rf-ob_90} & L'Admin deve poter visualizzare una pagina separata contenente lo storico totale degli ordini di tutti i Clienti & \hyperref[uc_36]{UC\_36} \\
	\hline
	RF-OB\_91 \hypertarget{rf-ob_91} & Il Cliente deve poter visualizzare una pagina separata contente lo storico totale dei suoi ordini & \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_92 \hypertarget{rf-ob_92} & La lista completa degli ordini deve essere visualizzata in pagine contenenti al massimo 10 ordini ciascuna & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_93 \hypertarget{rf-ob_93} & Il caricamento di una pagina non implica il caricamento delle pagine successive & \hyperref[uc_36]{UC\_36} \newline \hyperref[uc_45]{UC\_45} \\
	\hline
	RF-OB\_94 \hypertarget{rf-ob_94} & L'Utente deve poter visualizzare il singolo ordine nello storico & \hyperref[uc_36.1]{UC\_36.1} \newline \hyperref[uc_45.1]{UC\_45.1} \\
	\hline
	RF-OB\_95 \hypertarget{rf-ob_95} & L'Utente deve poter visualizzare il codice ordine & \hyperref[uc_36.1.1]{UC\_36.1.1} \newline \hyperref[uc_45.1.1]{UC\_45.1.1} \\
	\hline
	RF-OB\_96 \hypertarget{rf-ob_96} & L'Utente deve poter visualizzare la data dell'ordine & \hyperref[uc_36.1.2]{UC\_36.1.2} \newline \hyperref[uc_45.1.2]{UC\_45.1.2} \\
	\hline
	RF-OB\_97 \hypertarget{rf-ob_97} & L'Admin deve poter visualizzare lo username del Cliente & \hyperref[uc_36.1.3]{UC\_36.1.3} \\
	\hline
	RF-OB\_98 \hypertarget{rf-ob_98} & L'Utente deve poter visualizzare il dettaglio di un ordine specifico & \hyperref[uc_37]{UC\_37} \newline \hyperref[uc_46]{UC\_46} \\
	\hline
	RF-OB\_99 \hypertarget{rf-ob_99} & L'Admin deve poter visualizzare lo username del Cliente & \hyperref[uc_37.1]{UC\_37.1} \\
	\hline
	RF-OB\_100 \hypertarget{rf-ob_100} & L'Utente deve poter visualizzare i prodotti dell'ordine & \hyperref[uc_37.2]{UC\_37.2} \newline \hyperref[uc_46.1]{UC\_46.1} \\
	\hline
	RF-OB\_101 \hypertarget{rf-ob_101} & L'Utente deve poter visualizzare il nome dei prodotti & \hyperref[uc_37.2.1]{UC\_37.2.1} \newline \hyperref[uc_46.1.1]{UC\_46.1.1} \\
	\hline
	RF-OB\_102 \hypertarget{rf-ob_102} & L'Utente deve poter visualizzare la descrizione dei prodotti & \hyperref[uc_37.2.2]{UC\_37.2.2} \newline \hyperref[uc_46.1.2]{UC\_46.1.2} \\
	\hline
	RF-OB\_103 \hypertarget{rf-ob_103} & L'Utente deve poter visualizzare la quantità dei prodotti & \hyperref[uc_37.2.3]{UC\_37.2.3} \newline \hyperref[uc_46.1.3]{UC\_46.1.3} \\
	\hline
	RF-OB\_104 \hypertarget{rf-ob_104} & L'Utente deve poter visualizzare la data dell'ordine & \hyperref[uc_37.3]{UC\_37.3} \newline \hyperref[uc_46.2]{UC\_46.2} \\
	\hline
	RF-OB\_105 \hypertarget{rf-ob_105} & L'Utente deve poter visualizzare il numero dell'ordine & \hyperref[uc_37.4]{UC\_37.4} \newline \hyperref[uc_46.3]{UC\_46.3} \\
	\hline
	RF-OB\_106 \hypertarget{rf-ob_106} & Il Cliente deve poter visualizzare il pulsante per duplicare l'ordine & \hyperref[uc_38]{UC\_38} \\
	\hline
	RF-OB\_107 \hypertarget{rf-ob_107} & Il Cliente deve poter cliccare sul pulsante per duplicare l'ordine & \hyperref[uc_38]{UC\_38} \\
	\hline
	RF-OB\_108 \hypertarget{rf-ob_108} & Il Cliente deve poter confermare la duplicazione dell'ordine & \hyperref[uc_38.1]{UC\_38.1} \\
	\hline
	RF-OB\_109 \hypertarget{rf-ob_109} & Il Cliente deve poter visualizzare la notifica di errore duplicazione ordine & \hyperref[uc_39]{UC\_39} \\
	\hline
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-DE\_59 \hypertarget{rf-de_59} & Il Cliente deve visualizzare il dropdown: \vr{Bug}, \vr{Richiesta di supporto}, \vr{Suggerimento} & \hyperref[uc_24.1]{UC\_24.1} \\
	\hline
	...
	\hline
	RF-DE\_71 \hypertarget{rf-de_71} & L'Admin deve poter ottenere il file di log in formato JSON & \hyperref[uc_29]{UC\_29} \\
	\hline
	RF-DE\_72 \hypertarget{rf-de_72} & L'Admin deve poter ottenere il file JSON dello storico ordini & \hyperref[uc_30]{UC\_30} \\
	\hline
	...
	\hline
	RF-DE\_77 \hypertarget{rf-de_77} & Il file JSON esportato deve contenere il campo id [integer]: identificativo univoco dell'ordine & \hyperref[uc_30]{UC\_30} \\
	\hline
	RF-DE\_78 \hypertarget{rf-de_78} & Il file JSON esportato deve contenere il campo cod\_cli [integer]: identificativo univoco del cliente & \hyperref[uc_30]{UC\_30} \\
	\hline
	RF-DE\_79 \hypertarget{rf-de_79} & Il file JSON esportato deve contenere il campo cod\_art [varchar(13)]: identificativo univoco dell'articolo & \hyperref[uc_30]{UC\_30} \\
	\hline
	RF-DE\_80 \hypertarget{rf-de_80} & Il file JSON esportato deve contenere il campo data\_ord [date]: data di inserimento dell'ordine & \hyperref[uc_30]{UC\_30} \\
	\hline
	RF-DE\_81 \hypertarget{rf-de_81} & Il file JSON esportato deve contenere il campo qta\_ordinata [float]: quantità che l'Utente ha ordinato nell'unità di misura dell'articolo & \hyperref[uc_30]{UC\_30} \\
	\hline
	RF-DE\_82 \hypertarget{rf-de_82} & Il file JSON esportato deve contenere il campo rif [integer/string]: rappresenta un riferimento al testo originario & \hyperref[uc_30]{UC\_30} \\
	\hline
	...
	\hline
	RF-DE\_85 \hypertarget{rf-de_85} & Il Cliente deve poter visualizzare una notifica di conferma della duplicazione & \hyperref[uc_34.2]{UC\_34.2} \\
	\hline
	RF-DE\_86 \hypertarget{rf-de_86} & L'Admin deve poter visualizzare le statistiche & \hyperref[uc_40]{UC\_40} \\
	\hline
	RF-DE\_87 \hypertarget{rf-de_87} & L'Admin deve poter visualizzare il numero di utenti presenti in quel momento & \hyperref[uc_40.1]{UC\_40.1} \\
	\hline
	RF-DE\_88 \hypertarget{rf-de_88} & L'Admin deve poter visualizzare il numero di acquisti completati tramite la piattaforma & \hyperref[uc_40.2]{UC\_40.2} \\
	\hline
	RF-DE\_89 \hypertarget{rf-de_89} & L'Admin deve poter visualizzare, in forma di testo, il modello AI utilizzato in quel momento nella pagina delle performance & \hyperref[uc_40.3]{UC\_40.3} \\
	\hline
	RF-DE\_90 \hypertarget{rf-de_90} & L'Utente deve poter visualizzare l'elenco dei comandi in una pagina web dedicata & \hyperref[uc_41]{UC\_41} \\
	\hline
	RF-DE\_91 \hypertarget{rf-de_91} & L'Utente deve poter visualizzare il pulsante contenente il per la pagina dell'elenco dei comandi in qualsiasi pagina & \hyperref[uc_41]{UC\_41} \\
	\hline
	RF-DE\_92 \hypertarget{rf-de_92} & L'Utente deve poter schiacciare il pulsante contenente il link per la pagina dell'elenco dei comandi in qualsiasi pagina & \hyperref[uc_41]{UC\_41} \\
	\hline
	RF-DE\_93 \hypertarget{rf-de_93} & Il Cliente deve poter visualizzare l'elenco dei comandi con la relativa spiegazione & \hyperref[uc_41]{UC\_41} \\
	\hline
	RF-DE\_94 \hypertarget{rf-de_94} & Il Cliente deve poter visualizzare l'elenco dei comandi con la relativa spiegazione & \hyperref[uc_42]{UC\_42} \\
	\hline
	...
	\hline
	RF-DE\_102 \hypertarget{rf-de_102} & Il Cliente deve poter visualizzare il menù a comparsa dei comandi disponibili & \hyperref[uc_43.1]{UC\_43.1} \\
	\hline
	RF-DE\_103 \hypertarget{rf-de_103} & Il Cliente deve poter visualizzare il comando \vr{/duplica} nel menù a comparsa & \hyperref[uc_43.1.1]{UC\_43.1.1} \\
	\hline
	RF-DE\_104 \hypertarget{rf-de_104} & Il Cliente deve poter visualizzare il comando \vr{/carrello} nel menù a comparsa & \hyperref[uc_43.1.2]{UC\_43.1.2} \\
	\hline
	RF-DE\_105 \hypertarget{rf-de_105} & Il Cliente deve poter visualizzare il comando \vr{/duplica\{xx\}} nel menù a comparsa & \hyperref[uc_43.1.3]{UC\_43.1.3} \\
	\hline
	RF-DE\_106 \hypertarget{rf-de_106} & Il Cliente deve poter visualizzare il comando \vr{/invia} nel menù a comparsa & \hyperref[uc_43.1.4]{UC\_43.1.4} \\
	\hline
	RF-DE\_107 \hypertarget{rf-de_107} & Il Cliente deve poter visualizzare il comando \vr{/annulla} nel menù a comparsa & \hyperref[uc_43.1.5]{UC\_43.1.5} \\
	\hline
	RF-DE\_108 \hypertarget{rf-de_108} & Il Cliente deve poter visualizzare il comando \vr{/comandi} nel menù a comparsa & \hyperref[uc_43.1.6]{UC\_43.1.6} \\
	\hline
	RF-DE\_109 \hypertarget{rf-de_109} & Il Cliente deve poter inviare un comando nella chat & \hyperref[uc_44]{UC\_44} \\
	\hline
	RF-DE\_110 \hypertarget{rf-de_110} & Il Cliente deve poter inviare il comando \vr{/duplica} nella chat & \hyperref[uc_44.1]{UC\_44.1} \\
	\hline
	RF-DE\_111 \hypertarget{rf-de_111} & Il Cliente deve poter inviare il comando \vr{/carrello} nella chat & \hyperref[uc_44.2]{UC\_44.2} \\
	\hline
	RF-DE\_112 \hypertarget{rf-de_112} & Il Cliente deve poter inviare il comando \vr{/duplica\{xx\}} nella chat & \hyperref[uc_44.3]{UC\_44.3} \\
	\hline
	RF-DE\_113 \hypertarget{rf-de_113} & Il Cliente deve poter inviare il comando \vr{/invia} nella chat & \hyperref[uc_44.4]{UC\_44.4} \\
	\hline
	RF-DE\_114 \hypertarget{rf-de_114} & Il Cliente deve poter inviare il comando \vr{/annulla} nella chat & \hyperref[uc_44.5]{UC\_44.5} \\
	\hline
...
\begin{longtable}{|>{\raggedright}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.5\textwidth}|>{\raggedright\arraybackslash}p{0.2\textwidth}|}
	...
	\hline
	RF-OP\_08 \hypertarget{rf-op_8} & Deve essere visualizzata una notifica a schermo che informa della corretta creazione dell'Utente & \hyperref[uc_32.2]{UC\_32.2} \\
	\hline
	RF-OP\_09 \hypertarget{rf-op_9} & L'Admin deve poter visualizzare la notifica di errore creazione utente & \hyperref[uc_33]{UC\_33}\\
	\hline
	\multicolumn{3}{c}{} \\
