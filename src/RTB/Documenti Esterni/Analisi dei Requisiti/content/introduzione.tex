\section{Introduzione}
	...
	\begin{itemize}
	    ...
	    \item il \textbf{Team di Verifica} per la definizione delle strategie di test$^G$ e validazione$^G$.
	\end{itemize}
	...
	\begin{itemize}
	    ...
	    \item Generazione di ordini strutturati in formati standard (JSON$^G$, XML) compatibili con ERP$^G$;
	...
	Per tutti i termini tecnici, gli acronimi e le definizioni utilizzate nel documento si rimanda al \href{https://nullpointersgroup.github$^G$.io/Documentazione/output/RTB/Documentazione_interna/Glossario.pdf}{Glossario}, disponibile come documento separato. \\
	...
	\url{https://nullpointersgroup.github$^G$.io/Documentazione/output/RTB/Documenti\%20Interni/Norme_di_Progetto.pdf}\\[3pt]
	...
	\url{https://ieeexplore.ieee$^G$.org/document/720574} \\[3pt]
	\textbf{Ultima consultazione: 16 Dicembre 2025}
    ...
    \url{https://nullpointersgroup.github$^G$.io/Documentazione/output/RTB/Documentazione_interna/Glossario.pdf}\\[3pt]
    \textbf{Ultima consultazione: 16 Dicembre 2025}
