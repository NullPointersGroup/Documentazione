...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item L'Utente inserisce lo usernale $\rightarrow$ Vedi \hyperref[uc_02.1]{UC\_02.1}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{User Story}: L'Utente vuole inserire lo username per l'autenticazione
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{User Story}: L'Utente vuole inserire la password per l'autenticazione
\end{itemize}