...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Il sistema visualizza il riepilogo del carrello, elencando ogni articolo aggiunto $\rightarrow$ Vedi \hyperref[uc_19.1]{UC\_19.1} (per ciascun articolo)
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni}: 
	\begin{itemize}
		\item Il sistema sta visualizzando il riepilogo del carrello (UC\_19)
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item Il sistema visualizza il nome dell'articolo
	\end{enumerate}
	\item \textbf{Precondizioni}: 
	\begin{itemize}
		\item Il sistema sta visualizzando un elemento del carrello (UC\_19.1)
	\end{itemize}
	\item \textbf{Postcondizioni}:
	\begin{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item Il sistema visualizza il prezzo dell'articolo
	\end{enumerate}
	\item \textbf{Precondizioni}: 
	\begin{itemize}
		\item Il sistema sta visualizzando un elemento del carrello (UC\_19.1)
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item Il sistema visualizza la quantità dell'articolo
	\end{enumerate}
	\item \textbf{Precondizioni}: 
	\begin{itemize}
		\item Il sistema sta visualizzando un elemento del carrello (UC\_19.1)
