...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Visualizza singolo elemento presente nel carrello $\rightarrow$ Vedi \hyperref[uc_19.1]{UC\_19.1}
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni}: 
	\begin{itemize}
		\item Il Cliente sta visualizzando il riepilogo del carrello $\rightarrow$ Vedi \hyperref[uc_19]{UC\_19}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni}: 
	\begin{itemize}
		\item Il Cliente sta visualizzando un elemento del carrello $\rightarrow$ Vedi \hyperref[uc_19.1]{UC\_19.1}
	\end{itemize}
	\item \textbf{Postcondizioni}:
	\begin{itemize}
