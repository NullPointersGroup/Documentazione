...
\begin{itemize}
	...
	\begin{enumerate}
        ...
        \item Il Cliente riceve conferma dell'invio del feedback
	\end{enumerate}
	...
	\begin{itemize}
		\item Il Cliente invia il feedback e riceve conferma
	\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni}:
	\begin{itemize}
		\item Il modulo di feedback è aperto e il campo tipologia visibile alIl Cliente
	\end{itemize}
	\item \textbf{Postcondizioni}:
	\begin{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni}:
	\begin{itemize}
		\item Il modulo di feedback è aperto e il campo descrizione visibile al Cliente
	\end{itemize}
	\item \textbf{Postcondizioni}:
	\begin{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Il Cliente visiona la conferma dell'invio del feedback
	\end{enumerate}
	\item \textbf{Precondizioni}:
	\begin{itemize}
	...
	\item \textbf{Postcondizioni}:
	\begin{itemize}
		\item Il Cliente invia il feedback al sistema
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni}:
	\begin{itemize}
		\item Il Cliente ha premuto il pulsante di invio del feedback
	\end{itemize}
	\item \textbf{Postcondizioni}:
	\begin{itemize}
