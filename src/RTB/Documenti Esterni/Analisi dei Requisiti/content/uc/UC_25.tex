...
\begin{itemize}
	...
	\begin{enumerate}
		\item L'Admin schiaccia il tasto per accedere alla pagina web di monitoraggio delle performance
		...
		\item L'Admin visualizza le statistiche presenti nella pagina delle performance $\rightarrow$ Vedi \hyperref[uc_40]{UC\_40}
	\end{enumerate}
	...
	\begin{itemize}
		\item Vengono visualizzate tutte le informazioni riguardanti le performance
	\end{itemize}
