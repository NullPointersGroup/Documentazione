...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Trigger}: Il Cliente vuole personalizzare la visualizzazione dei dati applicando filtri specifici, per trovare più facilmente le informazioni di interesse
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Trigger}: Il Cliente vuole filtrare i dati per intervallo di date, per concentrarsi su periodi specifici
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Trigger}: Il Cliente vuole filtrare i dati per prodotto specifico, per rintracciare informazioni relative ad articoli particolari
\end{itemize}