...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item L'Utente visualizza i prodotti dell'ordine specifico. $\rightarrow$ Vedi [UC\_37.2, §\ref{uc_37.2}]
		\item l'Utente visualizza la data dell'ordine specifico. $\rightarrow$ Vedi [UC\_37.3, §\ref{uc_37.3}]
	\end{itemize}
