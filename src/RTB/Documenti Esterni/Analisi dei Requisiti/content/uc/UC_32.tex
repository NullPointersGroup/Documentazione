...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Il sistema mostra una notifica di creazione riuscita $\rightarrow$ Vedi \hyperref[uc_32.4]{UC\_32.4}
	\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Scenari Alternativi}:
    \begin{itemize}
        \item L'Admin ha inserito uno username esistente o errato $\rightarrow$ Vedi \hyperref[uc_32.2.1]{UC\_32.2.1}
    \end{itemize}
    \item \textbf{Estensioni}:
    \begin{itemize}
...
UC\_32.2 presenta una ulteriore estensione, come mostrato in figura:

\begin{figure}[H]
    \centering 
    \includegraphics[width=0.8\textwidth]{AnalisiRequisiti/UC_32.2}
    \caption{Estensioni UC\_32.2: UC\_32.2.1}
\end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è online
        \item L'Utente non è registrato nel sistema
        \item L'Admin ha inserito uno username non valido o già esistente
    \end{itemize}
    \item \textbf{Postcondizioni}:
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenari Alternativi}:
    \begin{itemize}
        \item L'Utente ha inserito una email non valida $\rightarrow$ Vedi \hyperref[uc_32.3.1]{UC\_32.3.1}
        \item L'Utente ha inserito una email già presente nel sistema $\rightarrow$ Vedi \hyperref[uc_32.3.2]{UC\_32.3.2}
    \end{itemize}
    \item \textbf{Estensioni}:
    \begin{itemize}
...
\subsubsubsection{UC\_32.4: Notifica creazione riuscita}
\label{uc_32.4}
