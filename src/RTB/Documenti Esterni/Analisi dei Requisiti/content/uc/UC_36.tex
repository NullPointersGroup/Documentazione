...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{User Story}: L'Utente vuole visualizzare filtrando con delle preferenze, possibili scelte di filtro sono per Cliente (accessibile solo dall'Admin), per data o per prodotti
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{User Story}: L'Utente vuole visualizzare solo gli elementi in cui sono presenti i prodotti scelti, eventualmente già filtrati
\end{itemize}
