...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Trigger}: L'Admin vuole visualizzare il numero di acquisti completati fino a quel momento tramite la piattaforma
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Trigger}: L'Admin vuole visualizzare il modello utilizzato in quel momento tramite la piattaforma
\end{itemize}