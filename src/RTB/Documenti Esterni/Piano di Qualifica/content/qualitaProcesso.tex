...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|>{\centering\arraybackslash}p{0.13\textwidth}|
            ...
            \hline
            MQC\_01 & Earned Value & $\geq$ PV*0.8 & $\geq PV$ \\
            \hline
            ...
            \hline
            MQC\_07 & Estimate To Complete & $\leq$ (BAC - AC)*1.05 & $\leq$ (BAC - AC) \\
            \hline
            MQC\_08 & Time Estimate At Completion & entro $\pm 5\%$ del tempo pianificato & $\leq$ 2 settimane rispetto al tempo pianificato \\
            \hline
        \end{tabular}
    }
    \vspace{-0.3cm}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|>{\centering\arraybackslash}p{0.13\textwidth}|
            ...
            \textbf{Metrica} & \textbf{Nome} & \textbf{Valore accettabile} & \textbf{Valore ottimo} \\
            \hline
            MQC\_09 & Completeness Issue & $\geq 0.8$ & 1.0 \\
            \hline
        \end{tabular}
    }
    \vspace{-0.3cm}
