...
Rientrano in questa categoria processi come la gestione della configurazione, l'assicurazione della qualità, la verifica e la convalida.\\  
Le relative metriche servono a valutare quanto bene questo \vr{supporto} funzioni e contribuisca al successo del progetto.
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|>{\centering\arraybackslash}p{0.13\textwidth}|
            ...
            \textbf{Metrica} & \textbf{Nome} & \textbf{Valore accettabile} & \textbf{Valore ottimo} \\
            \hline
            MQC\_10 & Indice di Gulpease & $\geq 40$ & $\geq 60$ \\
            \hline
        \end{tabular}
    }
    \vspace{-0.3cm}
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|>{\centering\arraybackslash}p{0.13\textwidth}|
            ...
            \textbf{Metrica} & \textbf{Nome} & \textbf{Valore accettabile} & \textbf{Valore ottimo} \\
            \hline
            MQC\_12 & Quality Metrics Satisfied & $\geq 75\%$ & 100\% \\
            \hline
        \end{tabular}
    }
    \vspace{-0.3cm}
