...
\vspace*{0.05\textheight}
    ...
    con il presente documento il team \textbf{NullPointers Group} desidera comunicarVi formalmente la propria intenzione di sottoporsi alla revisione della Requirements and Technology Baseline in data 16 febbraio 2026.\\
	La revisione riguarderà il progetto sviluppato per il capitolato C8 (SmartOrder: Analisi multimodale per la
creazione automatica di ordini) proposto da Ergon Informatica Srl:
