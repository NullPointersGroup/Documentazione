...
\vspace*{0.05\textheight}
    ...
    con il presente documento il team \textbf{NullPointers Group} desidera comunicarVi formalmente la propria intenzione di sottoporsi alla revisione della Requirements and Technology Baseline in data successiva al 16 febbraio 2026.\\
	La revisione riguarderà il progetto sviluppato per il capitolato C8 proposto da Ergon Informatica Srl:
    
    \begin{center}
        \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C8.pdf}{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C8.pdf}
    \end{center}
    ...
    Tutta la documentazione prodotta per la RTB è consultabile e sempre aggiornata nella relativa sezione della nostra repository, accessibile al link:
    
    \begin{center}
        \url{https://github.com/NullPointersGroup/Documentazione}
    \end{center}
