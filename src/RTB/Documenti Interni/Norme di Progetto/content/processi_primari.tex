\section{Processi Primari}
	...
	\begin{itemize}[itemsep=0pt, parsep=1pt, label=$\scriptstyle\bullet$]
	    ...
	    \item \textbf{WhatsApp}: per la comunicazione sincrona tra il team e la proponente.
	\end{itemize}
    ...
    \begin{itemize}[itemsep=0pt, parsep=1pt, label=$\scriptstyle\bullet$]
		...
		\item La \ulhref{https://nullpointersgroup.github.io/Documentazione/output/RTB/Documenti\%20Esterni/Lettera\_di\_Presentazione.pdf}{Lettera di presentazione} per la Requirements and Technology Baseline (RTB)$^{G}$;
		\item La \ulhref{https://nullpointersgroup.github.io/Documentazione/output/PB/Documenti\%20Esterni/Lettera\_di\_Presentazione.pdf}{Lettera di presentazione} per la Product Baseline (PB)$^{G}$.
	\end{itemize}
	...
	Per ogni sprint include i ruoli e le responsabilità, l’analisi dei rischi, le scadenze e la stima di tempi e costi, aggiornando il consumo orario previsto 
	ed effettivo e i costi stimati.\\ Rappresenta uno strumento operativo fondamentale per coordinare il team, gestire le risorse, tracciare le decisioni e 
