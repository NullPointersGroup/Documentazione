\section{Introduzione}
	...
	Il presente documento nasce per descrivere il Way of Working$^G$ adottato da \textbf{\vr{NullPointers Group}} durante lo svolgimento del progetto$^G$ SmartOrder. Il framework$^G$ di riferimento è lo standard ISO/IEC 12207:1995, che prevede tre tipologie di processi:
	\begin{itemize}
...
\subsection{Glossario}
    ...
    In accordo con quanto stabilito nel \underline{\href{https://nullpointersgroup.github.io/Documentazione/output/RTB/Verbali\%20Interni/2025-11-06\_verbale\_interno.pdf}{verbale interno del 6 novembre 2025}}, si è deciso di adottare il glossario come strumento ufficiale per la standardizzazione della terminologia di progetto$^G$ e di assegnare la responsabilità della sua manutenzione$^G$ alla figura del Referente.\\
