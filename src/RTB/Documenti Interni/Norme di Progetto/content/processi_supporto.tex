...
I test$^G$ di Sistema verificano il comportamento del sistema nella sua interezza, valutandone la conformità rispetto ai requisiti funzionali e non funzionali definiti nel documento di Analisi dei Requisiti$^G$. Questi test$^G$ permettono di validare aspetti quali la correttezza funzionale, l'affidabilità, la robustezza e la gestione degli errori.

\subsubsubsection{Test di Accettazione}
I Test$^G$ di Accettazione verificano che il sistema funzioni nella sua interezza e che soddisfi le aspettative ed i requisiti richiesti dalla proponente$^G$.
