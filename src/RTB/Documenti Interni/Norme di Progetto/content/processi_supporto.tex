...
\end{itemize}
Ogni test è associato ai requisiti che intende verificare, secondo quanto definito nel Piano di Qualifica.
...
I test di Sistema verificano il comportamento del sistema nella sua interezza, valutandone la conformità rispetto ai requisiti funzionali e non funzionali definiti nel documento di Analisi dei Requisiti.
Questi test permettono di validare aspetti quali la correttezza funzionale, l'affidabilità, la robustezza e la gestione degli errori.
