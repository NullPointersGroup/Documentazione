...
\begin{itemize}[itemsep=3pt, parsep=1pt, label=$\scriptstyle\bullet$]
    ...
    \item Automazione$^G$: GitHub$^G$ Action$^G$, script Python$^G$ e Lua
...
\begin{itemize}[itemsep=3pt, parsep=1pt, label=$\scriptstyle\bullet$]
    ...
    \item \textbf{PoC}: repository$^G$ dove viene salvato e versionato il codice sorgente per il Proof of Concept$^G$.
