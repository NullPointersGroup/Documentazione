...
\begin{enumerate}
    ...
    \item \textbf{Python}: linguaggio di programmazione versatile, utilizzato per implementare API$^G$ REST, gestire le comunicazioni con modelli di machine learning e con il database, e realizzare il back-end.
