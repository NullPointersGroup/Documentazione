...
\term{LOC}
Acronimo di \textit{Lines of Code}, le linee di codice totali che compongono un progetto.

\term{Lua}
Un linguaggio di programmazione dinamico e procedurale, utilizzato come linguaggio di scripting per automatizzare vari processi.
