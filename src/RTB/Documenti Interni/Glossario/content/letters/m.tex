...
Una branca dell'intelligenza artificiale che permette ad un computer di svolgere un compito apprendendo dai dati forniti e 
migliorando le sue prestazione nel tempo tramite più dati ed esperienze.

\term{Major}
Una modifica atta ad approvare un documento in una sua versione \vr{pronta al rilascio}. In un sistema di versionamento x.y.z, la Major è rappresentata dalla lettera x, e ogni
