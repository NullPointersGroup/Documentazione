...
\term{Metodo Agile}
Metodo di sviluppo software per la gestione di progetti complessi basato sui cicli iterativi brevi chiamati \textit{Sprint}, che favorisce la felssibilità del progetto e la collaborazione continua.

\term{Milestone}
Periodo di tempo entro il quale il team si pone il raggiungimento di determinati obiettivi.

\term{Minimum Viable Product}
La prima versione di un prodotto che assolve le funzionalità minime per rispettare i requisiti obbligatori stabiliti dalla proponenti.
...
\term{Modifica}
Qualsiasi intervento sul codice esistente o sulla documentazione volto a correggere degli errori, aggiornare i contenuti o adattarli ai nuovi requisiti.
