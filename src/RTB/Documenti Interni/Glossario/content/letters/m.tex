...
modifica di tipo Major aggiorna un file dalla versione x.y.z alla versione (x+1).y.z.
...
\term{Minor}
Una modifica atta ad aggiungere migliorie o funzionalità significative. In un sistema di versionamento x.y.z, la Minor è rappresentata dalla lettera y, e ogni modifica
di tipo Minor aggiorna un file dalla versione x.y.z alla versione x.(y+1).z.
