...
\term{SM}
Codice stabilito dal Team, rappresenta un'attività, con corrispettiva issue in GitHub all'interno della Repository \vrs{SmartOrder}, indica dunque un'attività da svolgere

\term{SMD}
Codice stabilito dal Team, rappresenta un'attività, con corrispettiva issue in GitHub all'interno della Repository \vrs{Documentazione}, indica dunque un'attività da svolgere
