...
\term{Redattore}
Colui che scrive il documento, viene identificato come \vr{Autore} nel registro delle modifiche.
...
Definiscono cosa il sistema deve fare, descrivendo le sue azioni e funzioni specifiche. Sono le capacità che l'utente si aspetta, come \vr{aggiungere un prodotto al carrello} in un negozio online.

\term{Requisito non funzionale}
Specificano come il sistema deve comportarsi mentre svolge quelle funzioni. Si concentrano su qualità come le prestazioni, la sicurezza o l'affidabilità, ad esempio \vr{il sistema deve supportare 1000 utenti contemporanei senza rallentamenti}.
