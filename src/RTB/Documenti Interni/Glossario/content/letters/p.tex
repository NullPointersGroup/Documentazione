...
\term{POC}
Codice stabilito dal Team, rappresenta un’attività con corrispettiva issue in GitHub all’interno della repository dedicata al \textit{Proof of Concept}. Indica un’attività da svolgere relativa allo sviluppo del PoC; il codice è seguito da un numero incrementale che permette di distinguere univocamente una singola attività.
