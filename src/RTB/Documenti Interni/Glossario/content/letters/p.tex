...
\term{PostgreSQL}
Sistema di gestione di database relazionionali open source, not per la sua scalabilità e la conformità agli standard SQL.
...
\term{Python}
Linguaggio di programmazione di alto livello, opern source, noto per la sua sintassi chiara; è ampiamente utilizzato nel campo dell'intelligenza artificiale e del machine learning.