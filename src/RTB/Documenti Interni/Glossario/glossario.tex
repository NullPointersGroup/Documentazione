...
\renewcommand{\headrule}{\vspace{-1pt}\hrule height 0.4pt width \headwidth}
\renewcommand{\footrule}{\vspace{-1pt}\hrule height 0.4pt width \headwidth}


\fancyhead[L]{NullPointers Group}
\fancyhead[R]{Glossario\\Versione 0.1.0}
