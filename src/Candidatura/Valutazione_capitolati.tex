...
\begin{table}[htbp]
	\begin{tabular}{|c|c|c|c|c|}
		...
		\hline
		0.1 & 30 - 10 & Lisa Casagrande & - & Creazione e stesura documento \\
		\hline
	\end{tabular}
\end{table}
	...
	Nel presente documento viene esposta l'analisi dei capitolati d'appalto che abbiamo esaminato al fine di individuare quello più adatto alle competenze e agli obiettivi del team ''NullPointers Group''.
